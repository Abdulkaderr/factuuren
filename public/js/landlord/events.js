...
$(document).ready(function () {
    ...
    /** --------------------------------------------------------------------------------------------------
     *  [customer][error logs] - filter by log type
     *  Sets the selected option's URL as data-url and fires an ajax request to fetch the logs
     * -------------------------------------------------------------------------------------------------*/
    $(document).on('change', '#selectErrorLogType', function (e) {
        var value = $(this).val();
        if (value !== '0') {

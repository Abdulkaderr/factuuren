...
(9,	'89350153.04490019',	'2020-09-02 15:41:04',	'2025-12-26 09:40:53',	0,	'Support',	NULL,	'yes',	'everyone',	'sl-icon-folder',	'ticket',	'9-support',	0,	'0000-00-00 00:00:00',	'0000-00-00 00:00:00',	'',	'',	'',	'',	'',	'',	'',	'',	'',	'',	'',	'',	'',	'',	'',	'',	'',	'0000-00-00 00:00:00',	'0000-00-00 00:00:00',	0,	0,	0,	0),
...
CREATE TABLE `clients` (
  ...
  `client_custom_field_61` decimal(15,2) DEFAULT NULL,
  `client_custom_field_62` decimal(15,2) DEFAULT NULL,
  `client_custom_field_63` decimal(15,2) DEFAULT NULL,
  `client_custom_field_64` decimal(15,2) DEFAULT NULL,
  `client_custom_field_65` decimal(15,2) DEFAULT NULL,
  `client_custom_field_66` decimal(15,2) DEFAULT NULL,
  `client_custom_field_67` decimal(15,2) DEFAULT NULL,
  `client_custom_field_68` decimal(15,2) DEFAULT NULL,
  `client_custom_field_69` decimal(15,2) DEFAULT NULL,
  `client_custom_field_70` decimal(15,2) DEFAULT NULL,
...
CREATE TABLE `contracts` (
  ...
  `doc_value` decimal(15,2) DEFAULT NULL,
  ...
  `contract_automation_status` varchar(20) DEFAULT 'disabled',
  `contract_automation_create_project` varchar(10) DEFAULT 'no' COMMENT 'yes|no',
  ...
  `contract_automation_project_title` text DEFAULT NULL,
  `contract_automation_project_status` varchar(30) DEFAULT 'in_progress' COMMENT 'not_started|in_progress|on_hold',
  `contract_automation_create_tasks` varchar(10) DEFAULT 'no' COMMENT 'yes|no',
  `contract_automation_project_email_client` varchar(10) DEFAULT 'no' COMMENT 'yes|no',
  `contract_automation_create_invoice` varchar(10) DEFAULT 'no' COMMENT 'yes|no',
  `contract_automation_invoice_due_date` int(11) DEFAULT NULL,
  `contract_automation_invoice_email_client` varchar(10) DEFAULT 'no' COMMENT 'yes|no',
  `contract_automation_log_created_project_id` int(11) DEFAULT NULL,
  `contract_automation_log_created_invoice_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`doc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
(1,	'2021-01-09 17:02:59',	'2025-09-02 08:24:59',	1,	'text',	'',	'projects',	'project_custom_field_1',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
...
(11,	'2021-01-09 17:04:09',	'2025-12-11 17:38:52',	1,	'text',	'',	'clients',	'client_custom_field_1',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
(12,	'2021-01-09 17:04:15',	'2025-12-11 17:38:52',	5,	'text',	'',	'clients',	'client_custom_field_2',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
(13,	'2021-01-09 17:04:19',	'2025-12-11 17:38:52',	1,	'text',	'',	'clients',	'client_custom_field_3',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
...
(21,	'2021-01-09 17:05:07',	'2025-12-04 21:45:16',	2,	'text',	'',	'leads',	'lead_custom_field_1',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
(22,	'2021-01-09 17:05:12',	'2025-12-04 21:45:16',	1,	'text',	'',	'leads',	'lead_custom_field_2',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
(23,	'2021-01-09 17:05:17',	'2025-12-04 21:45:16',	1,	'text',	'',	'leads',	'lead_custom_field_3',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
(24,	'2021-01-09 17:05:22',	'2025-12-04 21:45:16',	1,	'text',	'',	'leads',	'lead_custom_field_4',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
(25,	'2021-01-09 17:05:27',	'2025-12-04 21:45:16',	1,	'text',	'',	'leads',	'lead_custom_field_5',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
(26,	'2021-01-09 17:05:32',	'2025-12-04 21:30:30',	1,	'text',	'',	'leads',	'lead_custom_field_6',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
(27,	'2021-01-09 17:05:37',	'2025-12-04 21:30:30',	1,	'text',	'',	'leads',	'lead_custom_field_7',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
(28,	'2021-01-09 17:05:42',	'2025-12-04 21:30:30',	1,	'text',	'',	'leads',	'lead_custom_field_8',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
(29,	'2021-01-09 17:05:48',	'2025-12-04 21:30:30',	1,	'text',	'',	'leads',	'lead_custom_field_9',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
(30,	'2021-01-09 17:05:53',	'2025-12-04 21:30:31',	1,	'text',	'',	'leads',	'lead_custom_field_10',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
...
(127,	'2021-07-04 18:06:09',	'2025-12-02 20:15:23',	6,	'paragraph',	'',	'leads',	'lead_custom_field_47',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
...
(122,	'2021-07-04 18:06:09',	'2025-12-02 20:15:27',	1,	'paragraph',	'',	'leads',	'lead_custom_field_42',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
(121,	'2021-07-04 18:06:09',	'2025-12-02 20:15:27',	1,	'paragraph',	'',	'leads',	'lead_custom_field_41',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
(120,	'2021-07-04 17:57:57',	'2025-12-02 20:15:36',	3,	'date',	'',	'leads',	'lead_custom_field_40',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
...
(128,	'2021-07-04 18:06:09',	'2025-12-02 20:15:27',	1,	'paragraph',	'',	'leads',	'lead_custom_field_48',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
(129,	'2021-07-04 18:06:09',	'2025-12-02 20:15:27',	1,	'paragraph',	'',	'leads',	'lead_custom_field_49',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
(130,	'2021-07-04 18:06:09',	'2025-12-02 20:15:27',	1,	'paragraph',	'',	'leads',	'lead_custom_field_50',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
...
(241,	'2021-07-04 18:36:41',	'2025-12-11 17:39:04',	1,	'date',	'',	'clients',	'client_custom_field_11',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
...
(252,	'2021-07-04 18:37:11',	'2025-09-02 08:25:02',	1,	'date',	'',	'projects',	'project_custom_field_12',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
...
(271,	'2021-07-04 18:37:44',	'2025-12-11 17:19:44',	1,	'paragraph',	'',	'clients',	'client_custom_field_21',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
...
(282,	'2021-07-04 18:37:54',	'2025-09-02 08:25:06',	1,	'paragraph',	'',	'projects',	'project_custom_field_22',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
...
(312,	'2021-07-04 18:38:32',	'2025-09-02 08:25:08',	1,	'checkbox',	'',	'projects',	'project_custom_field_32',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
...
(331,	'2021-07-04 18:38:59',	'2025-09-02 08:24:42',	3,	'dropdown',	'',	'clients',	'client_custom_field_41',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
...
(341,	'2021-07-04 18:39:09',	'2025-09-02 08:25:11',	1,	'dropdown',	'',	'projects',	'project_custom_field_41',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
...
(372,	'2021-07-04 18:39:46',	'2025-09-02 08:25:14',	1,	'number',	'',	'projects',	'project_custom_field_52',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
...
(402,	'2021-07-04 19:18:29',	'2025-09-02 08:25:17',	1,	'decimal',	'',	'projects',	'project_custom_field_62',	'',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'disabled',	'disabled',	'z'),
...
CREATE TABLE `estimates` (
  ...
  `bill_subtotal` decimal(15,2) DEFAULT NULL,
  `bill_subtotal_before_discount` decimal(10,2) DEFAULT 0.00,
  ...
  `bill_discount_amount` decimal(15,2) DEFAULT NULL,
  `bill_amount_before_tax` decimal(15,2) DEFAULT NULL,
  ...
  `bill_tax_total_amount` decimal(15,2) DEFAULT NULL,
  `bill_adjustment_description` varchar(250) DEFAULT NULL,
  `bill_adjustment_amount` decimal(15,2) DEFAULT NULL,
  `bill_final_amount` decimal(15,2) DEFAULT NULL,
...
(1,	'2026-03-10 08:05:30',	'2026-03-10 08:05:30',	0,	NULL,	'Default',	'yes',	'yes');

DROP TABLE IF EXISTS `filters`;
CREATE TABLE `filters` (
  `filter_id` int(11) NOT NULL AUTO_INCREMENT,
  `filter_created` datetime NOT NULL,
  `filter_updated` datetime NOT NULL,
  `filter_userid` int(11) DEFAULT NULL,
  `filter_type` varchar(100) DEFAULT NULL COMMENT 'projects | clients | invoices | estimates | products | contracts | proposals | tickets | tasks | leads | payments | subscriptions | expenses | timesheets | ',
  `filter_remember` varchar(5) DEFAULT 'no',
  `filter_payload` text DEFAULT NULL,
  `filter_filter_applied` varchar(3) DEFAULT 'no' COMMENT 'yes | no',
...
CREATE TABLE `invoices` (
  ...
  `bill_overdue_reminder_second_sent` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  `bill_overdue_reminder_third_sent` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  ...
  `bill_publishing_scheduled_status` varchar(20) DEFAULT '' COMMENT 'pending|published|failed',
  `bill_publishing_scheduled_log` text DEFAULT NULL,
  `bill_cancellation_date` datetime DEFAULT NULL,
  `bill_cancellation_userid` int(11) DEFAULT NULL,
  `bill_cancellation_reasons` text DEFAULT NULL,
  `billresource_type` text DEFAULT NULL COMMENT 'optional references',
  `billresource_id` int(11) DEFAULT NULL,
  `invoice_mapping_type` text DEFAULT NULL,
  `invoice_mapping_id` int(11) DEFAULT NULL,
  `mod_purchasing_stock_warehouse_id` int(11) DEFAULT NULL COMMENT 'warehouse for stock deduction',
  `bill_status` int(11) DEFAULT 1 COMMENT '1 = Draft : 2 = Due : 3 = Overdue : 4 Part Paid : 5 = Paid',
  `bill_status_trigger` varchar(20) DEFAULT 'automatic',
  ...
  KEY `bill_viewed_by_client` (`bill_viewed_by_client`),
  KEY `bill_status` (`bill_status`),
  KEY `bill_status_trigger` (`bill_status_trigger`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='[truncate]';


DROP TABLE IF EXISTS `invoice_statuses`;
CREATE TABLE `invoice_statuses` (
  `invoicestatus_id` int(11) NOT NULL AUTO_INCREMENT,
  `invoicestatus_created` datetime DEFAULT NULL,
  `invoicestatus_creatorid` int(11) DEFAULT NULL,
  `invoicestatus_updated` datetime DEFAULT NULL,
  `invoicestatus_title` varchar(200) DEFAULT NULL,
  `invoicestatus_color` varchar(50) DEFAULT NULL,
  `invoicestatus_position` int(11) DEFAULT NULL,
  `invoicestatus_system_default` varchar(10) DEFAULT 'no',
  PRIMARY KEY (`invoicestatus_id`),
  KEY `invoicestatus_creatorid` (`invoicestatus_creatorid`),
  KEY `invoicestatus_position` (`invoicestatus_position`),
  KEY `invoicestatus_system_default` (`invoicestatus_system_default`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='1 = Draft : 2 = Due : 3 = Overdue : 4 Part Paid : 5 = Paid';

INSERT INTO `invoice_statuses` (`invoicestatus_id`, `invoicestatus_created`, `invoicestatus_creatorid`, `invoicestatus_updated`, `invoicestatus_title`, `invoicestatus_color`, `invoicestatus_position`, `invoicestatus_system_default`) VALUES
(1,	'2026-03-10 08:05:30',	1,	'2026-03-10 08:05:30',	'Draft',	'default',	1,	'yes'),
(2,	'2026-03-10 08:05:30',	1,	'2026-03-10 08:05:30',	'Due',	'info',	2,	'yes'),
(3,	'2026-03-10 08:05:30',	1,	'2026-03-10 08:05:30',	'Overdue',	'danger',	3,	'yes'),
(4,	'2026-03-10 08:05:30',	1,	'2026-03-10 08:05:30',	'Part Paid',	'warning',	4,	'yes'),
(5,	'2026-03-10 08:05:30',	1,	'2026-03-10 08:05:30',	'Paid',	'success',	5,	'yes'),
(20,	'2026-03-10 08:05:30',	1,	'2026-03-10 08:05:30',	'Cancelled',	'danger',	6,	'yes');

DROP TABLE IF EXISTS `items`;
CREATE TABLE `items` (
  `item_id` int(11) NOT NULL AUTO_INCREMENT,
  `item_importid` varchar(100) DEFAULT NULL,
  ...
  `item_description` text DEFAULT NULL COMMENT '2025: Actually being used as the item name',
  `item_notes` text DEFAULT NULL COMMENT '2025: Actually being used as the description',
  `item_rate` decimal(15,2) NOT NULL,
  `item_tax_status` varchar(100) NOT NULL DEFAULT 'taxable' COMMENT 'taxable|exempt',
  `item_default_tax` int(11) NOT NULL DEFAULT 5 COMMENT 'default item tax rate id (5  = No Tax)',
  ...
  `item_custom_field_1` text DEFAULT NULL,
  `item_custom_field_2` text DEFAULT NULL,
  `item_custom_field_3` text DEFAULT NULL,
  `item_custom_field_4` text DEFAULT NULL,
  `item_custom_field_5` text DEFAULT NULL,
  `item_custom_field_6` text DEFAULT NULL,
  `item_custom_field_7` text DEFAULT NULL,
  `item_custom_field_8` text DEFAULT NULL,
  `item_custom_field_9` text DEFAULT NULL,
  `item_custom_field_10` text DEFAULT NULL,
  `mod_purchasing_stock_code` varchar(250) DEFAULT NULL,
  `mod_purchasing_minimum_stock_level` int(11) DEFAULT NULL COMMENT '[purchasing module] min stock level',
  `mod_purchasing_stock_tracking_enabled` varchar(5) DEFAULT 'no' COMMENT '[purchasing module] yes|no - enable stock tracking for this item',
  `item_unit` int(11) DEFAULT NULL,
  PRIMARY KEY (`item_id`),
  KEY `item_categoryid` (`item_categoryid`),
  KEY `idx_item_importid` (`item_importid`),
  KEY `idx_item_unit` (`item_unit`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='[truncate]';


DROP TABLE IF EXISTS `items_custom_fields`;
CREATE TABLE `items_custom_fields` (
  `items_custom_id` int(11) NOT NULL AUTO_INCREMENT,
  `items_custom_field_created` datetime DEFAULT NULL,
  `items_custom_field_updated` datetime DEFAULT NULL,
  `items_custom_field_creatorid` int(11) DEFAULT NULL,
  `items_custom_field_name` text DEFAULT NULL,
  `items_custom_field_status` varchar(20) DEFAULT 'disabled' COMMENT 'enabled | disabled',
  `items_custom_field_show_on_invoice` varchar(5) DEFAULT 'no' COMMENT 'yes | no',
  PRIMARY KEY (`items_custom_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

INSERT INTO `items_custom_fields` (`items_custom_id`, `items_custom_field_created`, `items_custom_field_updated`, `items_custom_field_creatorid`, `items_custom_field_name`, `items_custom_field_status`, `items_custom_field_show_on_invoice`) VALUES
(1,	'2026-03-10 08:05:30',	'2026-03-10 08:05:30',	0,	NULL,	'disabled',	'no'),
(2,	'2026-03-10 08:05:30',	'2026-03-10 08:05:30',	0,	NULL,	'disabled',	'no'),
(3,	'2026-03-10 08:05:30',	'2026-03-10 08:05:30',	0,	NULL,	'disabled',	'no'),
(4,	'2026-03-10 08:05:30',	'2026-03-10 08:05:30',	0,	NULL,	'disabled',	'no'),
(5,	'2026-03-10 08:05:30',	'2026-03-10 08:05:30',	0,	NULL,	'disabled',	'no'),
(6,	'2026-03-10 08:05:30',	'2026-03-10 08:05:30',	0,	NULL,	'disabled',	'no'),
(7,	'2026-03-10 08:05:30',	'2026-03-10 08:05:30',	0,	NULL,	'disabled',	'no'),
(8,	'2026-03-10 08:05:30',	'2026-03-10 08:05:30',	0,	NULL,	'disabled',	'no'),
(9,	'2026-03-10 08:05:30',	'2026-03-10 08:05:30',	0,	NULL,	'disabled',	'no'),
(10,	'2026-03-10 08:05:30',	'2026-03-10 08:05:30',	0,	NULL,	'disabled',	'no');
...
(1,	'2026-03-10 08:05:30',	'2026-03-10 08:05:30',	0,	'Frequently Asked Questions',	'Answers to some of the most frequently asked questions',	1,	'everyone',	'1-frequently-asked-questions',	'sl-icon-call-out',	'text',	'yes');
...
CREATE TABLE `leads` (
  ...
  `lead_custom_field_131` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_132` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_133` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_134` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_135` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_136` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_137` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_138` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_139` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_140` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_141` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_142` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_143` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_144` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_145` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_146` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_147` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_148` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_149` decimal(15,2) DEFAULT NULL,
  `lead_custom_field_150` decimal(15,2) DEFAULT NULL,
...
(1,	'2026-03-10 08:05:30',	0,	'2026-03-10 08:05:30',	'New',	1,	'default',	'yes'),
(2,	'2026-03-10 08:05:30',	0,	'2026-03-10 08:05:30',	'Converted',	6,	'success',	'yes'),
(3,	'2026-03-10 08:05:30',	0,	'2026-03-10 08:05:30',	'Qualified',	3,	'info',	'no'),
(4,	'2026-03-10 08:05:30',	0,	'2026-03-10 08:05:30',	'Proposal Sent',	5,	'lime',	'no'),
(5,	'2026-03-10 08:05:30',	0,	'2026-03-10 08:05:30',	'Contacted',	2,	'warning',	'no'),
(7,	'2026-03-10 08:05:30',	0,	'2026-03-10 08:05:30',	'Disqualified',	4,	'danger',	'no');
...
CREATE TABLE `lineitems` (
  ...
  `lineitem_uniqueid` varchar(50) DEFAULT NULL,
  `lineitem_position` int(11) DEFAULT NULL,
  `lineitem_created` datetime DEFAULT NULL,
  `lineitem_updated` datetime DEFAULT NULL,
  `lineitem_description` text DEFAULT NULL COMMENT 'short description - required',
  `lineitem_long_description` text DEFAULT NULL COMMENT 'long description - optional',
  ...
  `lineitem_discount_type` varchar(30) DEFAULT 'none' COMMENT 'none | fixed | percentage',
  `lineitem_discount_value` decimal(15,2) DEFAULT 0.00 COMMENT 'The input value - either fixed amount or percentage',
  `lineitem_discount_amount` decimal(15,2) DEFAULT 0.00 COMMENT 'Calculated discount amount applied to line',
  ...
  `lineitem_recurring_status` varchar(20) DEFAULT 'recurring' COMMENT 'recurring|non-recurring - used when invoice is recurring',
  ...
  KEY `idx_lineitem_resource` (`lineitemresource_type`,`lineitemresource_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='[truncate]';
...
CREATE TABLE `payments` (
  ...
  `payment_status` varchar(15) DEFAULT 'paid' COMMENT 'paid | refunded',
...
CREATE TABLE `payment_sessions` (
  ...
  `session_amount` decimal(15,2) DEFAULT NULL,
...
CREATE TABLE `projects` (
  ...
  `project_billing_rate` decimal(15,2) DEFAULT NULL,
  ...
  `project_billing_costs_estimate` decimal(15,2) DEFAULT NULL,
  ...
  `project_custom_field_61` decimal(15,2) DEFAULT NULL,
  `project_custom_field_62` decimal(15,2) DEFAULT NULL,
  `project_custom_field_63` decimal(15,2) DEFAULT NULL,
  `project_custom_field_64` decimal(15,2) DEFAULT NULL,
  `project_custom_field_65` decimal(15,2) DEFAULT NULL,
  `project_custom_field_66` decimal(15,2) DEFAULT NULL,
  `project_custom_field_67` decimal(15,2) DEFAULT NULL,
  `project_custom_field_68` decimal(15,2) DEFAULT NULL,
  `project_custom_field_69` decimal(15,2) DEFAULT NULL,
  `project_custom_field_70` decimal(15,2) DEFAULT NULL,
  ...
  `project_automation_invoice_hourly_rate` decimal(15,2) DEFAULT NULL,
...
CREATE TABLE `proposals` (
  ...
  `proposal_automation_project_description` varchar(5) DEFAULT 'no' COMMENT 'yes|no',
...
CREATE TABLE `refunds` (
  ...
  `refund_created` datetime DEFAULT NULL,
  `refund_updated` datetime DEFAULT NULL,
  `refund_creatorid` int(11) DEFAULT NULL,
  `refund_uniqueid` varchar(50) DEFAULT NULL,
  `refund_paymentid` int(11) DEFAULT NULL COMMENT 'links to payments.payment_id',
  `refund_invoiceid` int(11) DEFAULT NULL COMMENT 'denormalized from payment',
  `refund_clientid` int(11) DEFAULT NULL COMMENT 'denormalized from payment',
  `refund_amount` decimal(15,2) DEFAULT NULL COMMENT 'always equals the full payment amount',
  `refund_date` date DEFAULT NULL,
  `refund_notes` text DEFAULT NULL,
  PRIMARY KEY (`refund_id`),
  KEY `refund_paymentid` (`refund_paymentid`),
  KEY `refund_clientid` (`refund_clientid`),
  KEY `refund_uniqueid` (`refund_uniqueid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `roles` (
  ...
  `role_invoices_scope` varchar(6) NOT NULL DEFAULT 'global' COMMENT 'own | global',
...
INSERT INTO `roles` (`role_id`, `role_created`, `role_updated`, `role_system`, `role_type`, `role_name`, `role_clients`, `role_contacts`, `role_contracts`, `role_invoices`, `role_invoices_scope`, `role_estimates`, `role_proposals`, `role_payments`, `role_items`, `role_tasks`, `role_tasks_scope`, `role_projects`, `role_projects_scope`, `role_projects_billing`, `role_leads`, `role_leads_scope`, `role_expenses`, `role_expenses_scope`, `role_timesheets`, `role_timesheets_scope`, `role_team`, `role_team_scope`, `role_tickets`, `role_knowledgebase`, `role_manage_knowledgebase_categories`, `role_assign_projects`, `role_assign_leads`, `role_assign_tasks`, `role_set_project_permissions`, `role_subscriptions`, `role_templates_projects`, `role_templates_contracts`, `role_templates_proposals`, `role_content_import`, `role_content_export`, `role_module_cs_affiliate`, `role_homepage`, `role_messages`, `role_reports`, `role_canned`, `role_canned_scope`, `modules`) VALUES
(1,	'2018-09-07 14:49:41',	'2026-01-21 17:35:47',	'yes',	'team',	'Administrator',	3,	4,	3,	3,	'global',	3,	4,	3,	3,	3,	'global',	3,	'global',	'2',	3,	'global',	3,	'global',	3,	'global',	3,	'global',	3,	3,	'yes',	'yes',	'yes',	'yes',	'yes',	'3',	'3',	'3',	'3',	'yes',	'yes',	'3',	'dashboard',	'yes',	'yes',	'yes',	'global',	'[{\"module_name\":\"Purchasing\",\"module_alias\":\"Purchasing\",\"module_permission\":\"admin\"},{\"module_name\":\"Sandbox\",\"module_alias\":\"Sandbox\",\"module_permission\":\"admin\"},{\"module_name\":\"Services\",\"module_alias\":\"Services\",\"module_permission\":\"admin\"},{\"module_name\":\"ActivityReport\",\"module_alias\":\"Activity Report\",\"module_permission\":\"admin\"},{\"module_name\":\"LabTools\",\"module_alias\":\"Lab Tools\",\"module_permission\":\"admin\"}]'),
(3,	'2018-09-07 14:49:41',	'2026-01-26 19:19:16',	'no',	'team',	'Staff',	1,	1,	0,	3,	'own',	0,	3,	0,	1,	3,	'own',	1,	'own',	'0',	3,	'own',	3,	'own',	2,	'own',	1,	'global',	3,	1,	'no',	'no',	'no',	'no',	'no',	'0',	'1',	'0',	'1',	'yes',	'yes',	'3',	'dashboard',	'yes',	'no',	'no',	'global',	'[{\"module_name\":\"Purchasing\",\"module_alias\":\"Purchasing\",\"module_permission\":\"none\"},{\"module_name\":\"Sandbox\",\"module_alias\":\"Sandbox\",\"module_permission\":\"none\"},{\"module_name\":\"Services\",\"module_alias\":\"Services\",\"module_permission\":\"none\"},{\"module_name\":\"ActivityReport\",\"module_alias\":\"Activity Report\",\"module_permission\":\"none\"},{\"module_name\":\"LabTools\",\"module_alias\":\"Lab Tools\",\"module_permission\":\"none\"}]'),
(2,	'2018-09-07 14:49:41',	'2026-01-21 17:35:47',	'yes',	'client',	'Client',	0,	3,	1,	1,	'global',	1,	0,	1,	0,	1,	'own',	1,	'own',	'0',	0,	'own',	0,	'own',	1,	'own',	1,	'global',	2,	1,	'no',	'no',	'no',	'no',	'no',	'1',	'0',	'0',	'0',	'no',	'no',	'3',	'dashboard',	'yes',	'no',	'yes',	'own',	'[{\"module_name\":\"Purchasing\",\"module_alias\":\"Purchasing\",\"module_permission\":\"none\"},{\"module_name\":\"Sandbox\",\"module_alias\":\"Sandbox\",\"module_permission\":\"none\"},{\"module_name\":\"Services\",\"module_alias\":\"Services\",\"module_permission\":\"none\"},{\"module_name\":\"ActivityReport\",\"module_alias\":\"Activity Report\",\"module_permission\":\"none\"},{\"module_name\":\"LabTools\",\"module_alias\":\"Lab Tools\",\"module_permission\":\"none\"}]');
...
CREATE TABLE `settings` (
  ...
  `settings_clients_disable_email_delivery` varchar(10) DEFAULT 'disabled' COMMENT 'enabled | disabled',
  `settings_clients_app_login` varchar(10) DEFAULT 'enabled' COMMENT 'enabled | disabled',
  ...
  `settings_estimates_show_view_status` varchar(3) DEFAULT 'yes' COMMENT 'yes|no',
  ...
  `settings_knowledgebase_allow_guest_viewing` varchar(3) DEFAULT 'no' COMMENT 'yes | no',
  ...
  `settings_system_close_modals_body_click` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  `settings_system_language_default` varchar(40) DEFAULT 'en' COMMENT 'english|french|etc',
  `settings_system_language_allow_users_to_change` varchar(3) DEFAULT 'yes' COMMENT 'yes|no',
  ...
  `settings_system_exporting_strip_html` varchar(3) DEFAULT 'yes' COMMENT 'yes|no',
  `settings_tags_allow_users_create` varchar(3) DEFAULT 'yes' COMMENT 'yes|no',
  `settings_leads_allow_private` varchar(3) DEFAULT 'yes' COMMENT 'yes|no',
  `settings_leads_allow_new_sources` varchar(3) DEFAULT 'yes' COMMENT 'yes|no',
  ...
  `settings_tasks_kanban_project_title` varchar(5) DEFAULT 'show' COMMENT 'show|hide',
  `settings_tasks_kanban_client_name` varchar(5) DEFAULT 'show' COMMENT 'show|hide',
  `settings_tasks_kanban_tags` text DEFAULT NULL,
  `settings_tasks_kanban_reminder` text DEFAULT NULL,
  `settings_tasks_kanban_pending_checklists` text DEFAULT NULL COMMENT 'yes|no',
  `settings_tasks_send_overdue_reminder` varchar(3) DEFAULT 'yes' COMMENT 'yes|no',
  ...
  `settings_projects_categories_main_menu` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  `settings_projects_default_hourly_rate` decimal(15,2) DEFAULT NULL,
...
CREATE TABLE `settings2` (
  ...
  `settings2_estimates_automation_create_project` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  ...
  `settings2_estimates_automation_project_email_client` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  `settings2_estimates_automation_create_invoice` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  `settings2_estimates_automation_invoice_email_client` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  `settings2_estimates_automation_invoice_due_date` int(11) DEFAULT 7,
  `settings2_estimates_automation_create_tasks` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  `settings2_estimates_automation_copy_attachments` varchar(3) DEFAULT 'yes' COMMENT 'yes|no',
  `settings2_extras_dimensions_billing` varchar(10) DEFAULT 'disabled' COMMENT 'enabled|disabled',
  `settings2_extras_dimensions_default_unit` varchar(20) DEFAULT 'm2',
  `settings2_extras_dimensions_show_measurements` varchar(3) DEFAULT 'no' COMMENT 'show on the pd,web etc',
  ...
  `settings2_invoices_due_days` int(11) DEFAULT 7,
  `settings2_invoices_default_mode` text DEFAULT NULL COMMENT 'inline|summary',
  `settings2_invoices_show_long_description` varchar(3) DEFAULT 'no' COMMENT 'yes | no',
  `settings2_invoices_second_reminder_days` tinyint(4) DEFAULT 7 COMMENT '0 = disabled',
  `settings2_invoices_third_reminder_days` tinyint(4) DEFAULT 14 COMMENT '0 = disabled',
  `settings2_invoices_footer_text` mediumtext DEFAULT NULL,
  `settings2_projects_automation_default_status` varchar(10) DEFAULT 'disabled' COMMENT 'disabled|enabled',
  `settings2_projects_automation_create_invoices` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  `settings2_projects_automation_convert_estimates_to_invoices` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  `settings2_projects_automation_skip_draft_estimates` varchar(3) DEFAULT 'yes' COMMENT 'yes|no',
  `settings2_projects_automation_skip_declined_estimates` varchar(3) DEFAULT 'yes' COMMENT 'yes|no',
  `settings2_projects_automation_invoice_unbilled_hours` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  `settings2_projects_automation_invoice_hourly_rate` decimal(15,2) DEFAULT NULL,
  `settings2_projects_automation_invoice_hourly_tax_1` int(11) DEFAULT NULL,
  `settings2_projects_automation_invoice_email_client` varchar(3) DEFAULT 'no',
  ...
  `settings2_proposals_automation_project_description` text DEFAULT NULL COMMENT 'yes|no',
  ...
  `settings2_file_folders_manage_assigned` varchar(3) DEFAULT 'yes' COMMENT 'yes|no',
  `settings2_file_folders_manage_project_manager` varchar(3) DEFAULT 'yes' COMMENT 'yes|no',
  `settings2_file_folders_manage_client` varchar(3) DEFAULT 'yes' COMMENT 'yes|no',
  `settings2_file_bulk_download` varchar(10) DEFAULT 'enabled' COMMENT 'enabled|disabled',
  `settings2_flutterwave_secret_key` text DEFAULT NULL COMMENT 'Test or Live secret key',
  `settings2_flutterwave_public_key` text DEFAULT NULL COMMENT 'Test or Live public key',
  `settings2_flutterwave_webhook_hash` text DEFAULT NULL COMMENT 'User-defined secret hash for webhook verification',
  `settings2_flutterwave_currency_code` text DEFAULT NULL COMMENT 'e.g. NGN, KES, GHS, USD',
  `settings2_flutterwave_display_name` text DEFAULT NULL COMMENT 'Display name on payment page',
  `settings2_flutterwave_status` varchar(10) DEFAULT 'disabled' COMMENT 'enabled|disabled',
  ...
  `settings2_spaces_team_space_title` varchar(50) DEFAULT 'Team Space',
  `settings2_spaces_user_space_title` varchar(50) DEFAULT 'My Space',
  `settings2_spaces_team_space_menu_name` varchar(50) DEFAULT 'Team Space',
  `settings2_spaces_user_space_menu_name` varchar(50) DEFAULT 'Space',
  ...
  `settings2_tickets_replying_interface` varchar(15) DEFAULT 'popup' COMMENT 'popup|inline',
  `settings2_tickets_archive_button` varchar(3) DEFAULT 'yes' COMMENT 'yes|no',
  `settings2_tickets_on_reply` text DEFAULT '' COMMENT 'stay-on-page|return-to-list',
  `settings2_timesheets_show_recorded_by` text DEFAULT NULL COMMENT 'yes|no',
  `settings2_projects_cover_images_show_on_project` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  ...
  `settings2_tweak_reports_truncate_long_text` varchar(3) DEFAULT 'yes' COMMENT 'yes|no',
  ...
  `settings2_contracts_automation_default_status` varchar(10) DEFAULT 'disabled' COMMENT 'disabled|enabled',
  `settings2_contracts_automation_create_project` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  `settings2_contracts_automation_project_status` varchar(30) DEFAULT 'in_progress' COMMENT 'not_started|in_progress|on_hold',
  `settings2_contracts_automation_project_email_client` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  `settings2_contracts_automation_create_invoice` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  `settings2_contracts_automation_invoice_email_client` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  `settings2_contracts_automation_invoice_due_date` int(11) DEFAULT 7,
  `settings2_contracts_automation_create_tasks` varchar(3) DEFAULT 'no' COMMENT 'yes|no',
  PRIMARY KEY (`settings2_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

INSERT INTO `settings2` (`settings2_id`, `settings2_created`, `settings2_updated`, `settings2_bills_pdf_css`, `settings2_calendar_projects_colour`, `settings2_calendar_tasks_colour`, `settings2_calendar_events_colour`, `settings2_calendar_reminder_duration`, `settings2_calendar_reminder_period`, `settings2_calendar_events_assigning`, `settings2_calendar_first_day`, `settings2_calendar_default_event_duration`, `settings2_calendar_send_reminder_projects`, `settings2_calendar_send_reminder_tasks`, `settings2_calendar_send_reminder_events`, `settings2_captcha_api_site_key`, `settings2_captcha_api_secret_key`, `settings2_captcha_status`, `settings2_estimates_automation_default_status`, `settings2_estimates_automation_create_project`, `settings2_estimates_automation_project_status`, `settings2_estimates_automation_project_title`, `settings2_estimates_automation_project_email_client`, `settings2_estimates_automation_create_invoice`, `settings2_estimates_automation_invoice_email_client`, `settings2_estimates_automation_invoice_due_date`, `settings2_estimates_automation_create_tasks`, `settings2_estimates_automation_copy_attachments`, `settings2_extras_dimensions_billing`, `settings2_extras_dimensions_default_unit`, `settings2_extras_dimensions_show_measurements`, `settings2_importing_leads_duplicates_name`, `settings2_importing_leads_duplicates_email`, `settings2_importing_leads_duplicates_telephone`, `settings2_importing_leads_duplicates_company`, `settings2_importing_clients_duplicates_email`, `settings2_importing_clients_duplicates_telephone`, `settings2_importing_clients_duplicates_company`, `settings2_invoices_due_days`, `settings2_invoices_default_mode`, `settings2_invoices_show_long_description`, `settings2_invoices_second_reminder_days`, `settings2_invoices_third_reminder_days`, `settings2_invoices_footer_text`, `settings2_projects_automation_default_status`, `settings2_projects_automation_create_invoices`, `settings2_projects_automation_convert_estimates_to_invoices`, `settings2_projects_automation_skip_draft_estimates`, `settings2_projects_automation_skip_declined_estimates`, `settings2_projects_automation_invoice_unbilled_hours`, `settings2_projects_automation_invoice_hourly_rate`, `settings2_projects_automation_invoice_hourly_tax_1`, `settings2_projects_automation_invoice_email_client`, `settings2_projects_automation_invoice_due_date`, `settings2_tasks_manage_dependencies`, `settings2_tap_secret_key`, `settings2_tap_publishable_key`, `settings2_tap_currency_code`, `settings2_tap_language`, `settings2_tap_display_name`, `settings2_tap_status`, `settings2_theme_css`, `settings2_paystack_secret_key`, `settings2_paystack_public_key`, `settings2_paystack_currency_code`, `settings2_paystack_display_name`, `settings2_paystack_status`, `settings2_proposals_automation_default_status`, `settings2_proposals_automation_create_project`, `settings2_proposals_automation_project_status`, `settings2_proposals_automation_project_email_client`, `settings2_proposals_automation_project_description`, `settings2_proposals_automation_create_invoice`, `settings2_proposals_automation_invoice_email_client`, `settings2_proposals_automation_invoice_due_date`, `settings2_proposals_automation_create_tasks`, `settings2_file_folders_status`, `settings2_file_folders_manage_assigned`, `settings2_file_folders_manage_project_manager`, `settings2_file_folders_manage_client`, `settings2_file_bulk_download`, `settings2_flutterwave_secret_key`, `settings2_flutterwave_public_key`, `settings2_flutterwave_webhook_hash`, `settings2_flutterwave_currency_code`, `settings2_flutterwave_display_name`, `settings2_flutterwave_status`, `settings2_search_category_limit`, `settings2_spaces_team_space_id`, `settings2_spaces_team_space_status`, `settings2_spaces_user_space_status`, `settings2_spaces_team_space_title`, `settings2_spaces_user_space_title`, `settings2_spaces_team_space_menu_name`, `settings2_spaces_user_space_menu_name`, `settings2_spaces_features_files`, `settings2_spaces_features_notes`, `settings2_spaces_features_comments`, `settings2_spaces_features_tasks`, `settings2_spaces_features_whiteboard`, `settings2_spaces_features_checklists`, `settings2_spaces_features_todos`, `settings2_spaces_features_reminders`, `settings2_tickets_replying_interface`, `settings2_tickets_archive_button`, `settings2_tickets_on_reply`, `settings2_timesheets_show_recorded_by`, `settings2_projects_cover_images_show_on_project`, `settings2_onboarding_status`, `settings2_onboarding_content`, `settings2_onboarding_view_status`, `settings2_tweak_reports_truncate_long_text`, `settings2_tweak_imap_tickets_import_limit`, `settings2_tweak_imap_connection_timeout`, `settings2_dompdf_fonts`, `settings2_contracts_automation_default_status`, `settings2_contracts_automation_create_project`, `settings2_contracts_automation_project_status`, `settings2_contracts_automation_project_email_client`, `settings2_contracts_automation_create_invoice`, `settings2_contracts_automation_invoice_email_client`, `settings2_contracts_automation_invoice_due_date`, `settings2_contracts_automation_create_tasks`) VALUES
(1,	'2026-03-10 08:05:30',	'2026-03-10 08:05:30',	'',	'#20AEE3',	'#6772E5',	'#24D2B5',	1,	'days',	'admin',	0,	30,	'due-date',	'due-date',	'start-date',	'',	'',	'disabled',	'disabled',	'yes',	'on_hold',	'New Project',	'yes',	'yes',	'yes',	7,	'yes',	'yes',	'disabled',	'm2',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	'no',	7,	'summary',	'no',	7,	14,	'',	'disabled',	'yes',	'yes',	'yes',	'yes',	'yes',	NULL,	NULL,	'yes',	7,	'super-users',	'',	'',	'',	'en',	'',	'disabled',	'',	'',	'',	'ZAR',	'',	'disabled',	'disabled',	'no',	'not_started',	'yes',	'no',	'no',	'yes',	7,	'yes',	'enabled',	'yes',	'yes',	'yes',	'enabled',	'',	'',	'',	'',	'',	'disabled',	5,	NULL,	'enabled',	'enabled',	'Team Workspace',	'My Workspace',	'Team Workspace',	'My Workspace',	'enabled',	'enabled',	'enabled',	'enabled',	'enabled',	'enabled',	'enabled',	'enabled',	'inline',	'yes',	'return-to-list',	'no',	'no',	'disabled',	'',	'seen',	'yes',	5,	60,	'default',	'enabled',	'yes',	'not_started',	'yes',	'yes',	'yes',	7,	'yes');
...
CREATE TABLE `subscriptions` (
  ...
  `subscription_subtotal` decimal(15,2) DEFAULT NULL,
  `subscription_amount_before_tax` decimal(15,2) DEFAULT NULL,
  `subscription_tax_percentage` decimal(10,2) DEFAULT 0.00 COMMENT 'percentage',
  `subscription_tax_amount` decimal(15,2) DEFAULT NULL,
  `subscription_final_amount` decimal(15,2) DEFAULT NULL,
...
CREATE TABLE `tasks` (
  ...
  `task_custom_field_61` decimal(15,2) DEFAULT NULL,
  `task_custom_field_62` decimal(15,2) DEFAULT NULL,
  `task_custom_field_63` decimal(15,2) DEFAULT NULL,
  `task_custom_field_64` decimal(15,2) DEFAULT NULL,
  `task_custom_field_65` decimal(15,2) DEFAULT NULL,
  `task_custom_field_66` decimal(15,2) DEFAULT NULL,
  `task_custom_field_67` decimal(15,2) DEFAULT NULL,
  `task_custom_field_68` decimal(15,2) DEFAULT NULL,
  `task_custom_field_69` decimal(15,2) DEFAULT NULL,
  `task_custom_field_70` decimal(15,2) DEFAULT NULL,
  ...
  `task_mapping_uniqueid` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`task_id`),
...
(1,	NULL,	0,	'2026-03-10 08:05:30',	'Normal',	1,	'lime',	'yes'),
(2,	NULL,	0,	'2026-03-10 08:05:30',	'Low',	2,	'success',	'no'),
(3,	NULL,	0,	'2026-03-10 08:05:30',	'High',	3,	'warning',	'no'),
(4,	NULL,	0,	'2026-03-10 08:05:30',	'Urgent',	4,	'danger',	'no');
...
CREATE TABLE `taxrates` (
  ...
  `taxrate_value` decimal(15,2) DEFAULT NULL,
...
(1,	'zero-rated-tax-rate',	'2026-03-10 08:05:30',	'2026-03-10 08:05:30',	0,	'No Tax',	0.00,	'system',	NULL,	NULL,	NULL,	'enabled');
...
CREATE TABLE `users` (
  ...
  `account_owner` varchar(5) DEFAULT 'no' COMMENT 'yes | no',
  `primary_admin` varchar(5) DEFAULT 'no' COMMENT 'yes | no (only 1 primary admin - created during setup)',
  `avatar_directory` text DEFAULT NULL,
  `avatar_filename` text DEFAULT NULL,
  `type` text NOT NULL COMMENT 'client | team |contact',
  `status` varchar(15) DEFAULT 'active' COMMENT 'active|suspended|deleted',
  ...
  `pref_language` varchar(50) DEFAULT 'english' COMMENT 'english|french|etc',
  `pref_email_notifications` varchar(5) DEFAULT 'yes' COMMENT 'yes | no',
  `pref_leftmenu_position` varchar(20) DEFAULT 'collapsed' COMMENT 'collapsed | open',
  `pref_statspanel_position` varchar(20) DEFAULT 'collapsed' COMMENT 'collapsed | open',
  `pref_filter_own_tasks` varchar(5) DEFAULT 'no' COMMENT 'Show only a users tasks in the tasks list',
  `pref_hide_completed_tasks` varchar(5) DEFAULT 'no' COMMENT 'yes | no',
  `pref_filter_own_projects` varchar(5) DEFAULT 'no' COMMENT 'Show only a users projects in the projects list',
  `pref_filter_show_archived_projects` varchar(5) DEFAULT 'no' COMMENT 'Show archived projects',
  `pref_filter_show_archived_tasks` varchar(5) DEFAULT 'no' COMMENT 'Show archived projects',
  `pref_filter_show_archived_leads` varchar(5) DEFAULT 'no' COMMENT 'Show archived projects',
  `pref_filter_show_archived_tickets` varchar(5) DEFAULT 'no' COMMENT 'Show archived tickets',
  `pref_filter_own_leads` varchar(5) DEFAULT 'no' COMMENT 'Show only a users projects in the leads list',
  `pref_view_tasks_layout` varchar(20) DEFAULT 'kanban' COMMENT 'list|kanban',
  `pref_view_leads_layout` varchar(20) DEFAULT 'kanban' COMMENT 'list|kanban',
  `pref_view_kanban_card_distraction_free` varchar(5) DEFAULT 'no' COMMENT 'yes|no',
  `pref_view_projects_layout` varchar(20) DEFAULT 'list' COMMENT 'list|card|milestone|pipeline|category|gnatt',
  `pref_theme` varchar(30) DEFAULT 'default',
  `pref_calendar_dates_projects` varchar(20) DEFAULT 'due' COMMENT 'start|due|start_due',
  `pref_calendar_dates_tasks` varchar(20) DEFAULT 'due' COMMENT 'start|due|start_due',
  `pref_calendar_dates_events` varchar(20) DEFAULT 'due' COMMENT 'start|due|start_due',
  `pref_calendar_view` varchar(20) DEFAULT 'own' COMMENT 'own|all',
  `remember_token` text DEFAULT NULL,
  `remember_filters_tickets_status` varchar(15) DEFAULT 'disabled' COMMENT 'enabled|disabled',
  `remember_filters_tickets_payload` text DEFAULT NULL,
  `remember_filters_projects_status` varchar(15) DEFAULT 'disabled' COMMENT 'enabled|disabled',
  `remember_filters_projects_payload` text DEFAULT NULL,
  `remember_filters_invoices_status` varchar(15) DEFAULT 'disabled' COMMENT 'enabled|disabled',
  `remember_filters_invoices_payload` text DEFAULT NULL,
  `remember_filters_estimates_status` varchar(15) DEFAULT 'disabled' COMMENT 'enabled|disabled',
  `remember_filters_estimates_payload` text DEFAULT NULL,
  `remember_filters_contracts_status` varchar(15) DEFAULT 'disabled' COMMENT 'enabled|disabled',
  `remember_filters_contracts_payload` text DEFAULT NULL,
  `remember_filters_payments_status` varchar(15) DEFAULT 'disabled' COMMENT 'enabled|disabled',
  `remember_filters_payments_payload` text DEFAULT NULL,
  `remember_filters_proposals_status` varchar(15) DEFAULT 'disabled' COMMENT 'enabled|disabled',
  `remember_filters_proposals_payload` text DEFAULT NULL,
  `remember_filters_clients_status` varchar(15) DEFAULT 'disabled' COMMENT 'enabled|disabled',
  `remember_filters_clients_payload` text DEFAULT NULL,
  `remember_filters_leads_status` varchar(15) DEFAULT 'disabled' COMMENT 'enabled|disabled',
  `remember_filters_leads_payload` text DEFAULT NULL,
  `remember_filters_tasks_status` varchar(15) DEFAULT 'disabled' COMMENT 'enabled|disabled',
  `remember_filters_tasks_payload` text DEFAULT NULL,
  `remember_filters_subscriptions_status` varchar(15) DEFAULT 'disabled' COMMENT 'enabled|disabled',
  `remember_filters_subscriptions_payload` text DEFAULT NULL,
  `remember_filters_products_status` varchar(15) DEFAULT 'disabled' COMMENT 'enabled|disabled',
  `remember_filters_products_payload` text DEFAULT NULL,
  `remember_filters_expenses_status` varchar(15) DEFAULT 'disabled' COMMENT 'enabled|disabled',
  `remember_filters_expenses_payload` text DEFAULT NULL,
  `remember_filters_timesheets_status` varchar(15) DEFAULT 'disabled' COMMENT 'enabled|disabled',
  ...
  `force_password_change` varchar(5) DEFAULT 'no' COMMENT 'yes|no',
  ...
  `dashboard_access` varchar(5) DEFAULT 'yes' COMMENT 'yes|no',
  `welcome_email_sent` varchar(5) DEFAULT 'no' COMMENT 'yes|no',
...
CREATE TABLE `webforms` (
  ...
  `webform_lead_source` text DEFAULT NULL,
...
CREATE TABLE `webhooks` (
  ...
  `webhooks_payment_amount` decimal(15,2) DEFAULT NULL,

...
class LineitemRepository {
    ...
    public function create($data = []) {
        ...
        //data
        $lineitem->lineitem_uniqueid = (isset($data['lineitem_uniqueid']) && $data['lineitem_uniqueid'] != '') ? $data['lineitem_uniqueid'] : str_unique();
        $lineitem->lineitem_position = $data['lineitem_position'];
        $lineitem->lineitem_description = $data['lineitem_description'];
        $lineitem->lineitem_long_description = (isset($data['lineitem_long_description'])) ? $data['lineitem_long_description'] : null;
        ...
        $lineitem->lineitem_discount_type = (isset($data['lineitem_discount_type'])) ? $data['lineitem_discount_type'] : 'none';
        $lineitem->lineitem_discount_value = (isset($data['lineitem_discount_value'])) ? $data['lineitem_discount_value'] : 0;
        $lineitem->lineitem_discount_amount = (isset($data['lineitem_discount_amount'])) ? $data['lineitem_discount_amount'] : 0;

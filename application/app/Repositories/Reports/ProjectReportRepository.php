...
class ProjectReportRepository {
    ...
    public function getCategory($type = '') {
        ...
        foreach ($categories as $category) {
            ...
            //sum_invoices
            $sum_invoices = \App\Models\Invoice::whereIn('bill_projectid', $project_ids)->whereNotIn('bill_status', [1])->sum('bill_final_amount');

            //sum_payments
            $sum_payments = \App\Models\Payment::whereIn('payment_projectid', $project_ids)->where('payment_status', 'paid')->sum('payment_amount');

...
class ClientRepository {
    ...
    public function create($data = []) {
        ...
        $client->client_company_name = request()->filled('client_company_name') ? request('client_company_name') : $full_name;
        ...
        $client->client_billing_invoice_due_days = request('client_billing_invoice_due_days');
    ...
    public function autocompleteFeed($type = '', $searchterm = '') {
        ...
        if ($type == 'company_name') {
            $query->selectRaw('client_company_name AS value, client_id AS id, client_billing_invoice_due_days');
        ...
        //add invoice_due_days attribute for each result
        $results->transform(function ($item) {
            $item->invoice_due_days = $item->client_billing_invoice_due_days ?? config('system.settings2_invoices_due_days', 7);
            return $item;
        });

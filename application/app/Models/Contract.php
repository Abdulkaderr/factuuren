...
class Contract extends Model {
    ...
    /** ---------------------------------------------------------------------------------------------
     * [todo]
     * 1. relationship; client(); Client model; client_id; doc_client_id; withDefault()
     * ---------------------------------------------------------------------------------------------*/
     ...
     * A contract has one linked estimate of document type.
     * Used to retrieve the estimate value (bill_final_amount) associated with this contract.
     */
    public function estimate() {
        return $this->hasOne('App\Models\Estimate', 'bill_contractid', 'doc_id')
            ->where('bill_estimate_type', 'document')
            ->withDefault();
    }
}
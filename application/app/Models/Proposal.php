...
class Proposal extends Model {
     ...
     * A proposal has one linked estimate of document type.
     * Used to retrieve the estimate value (bill_final_amount) associated with this proposal.
     */
    public function estimate() {
        return $this->hasOne('App\Models\Estimate', 'bill_proposalid', 'doc_id')

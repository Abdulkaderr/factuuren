...
class Kernel extends HttpKernel {
    ...
    protected $middlewareGroups = [
        ...
        'tenant' => [
            ...
            //[growcrm] [maintenance mode check]
            \App\Http\Middleware\Landlord\MaintenanceMode::class,
            ...
            //[MODULES][status and bootstrapping]
        ...
        'landlord' => [
            ...
            //[GROWNCRM] set role-based menu visibility for authenticated users
            \App\Http\Middleware\Landlord\Permissions::class,
        ],
    ...
    protected $routeMiddleware = [
        ...
        'clientsMiddlewareFiltering' => \App\Http\Middleware\Clients\Filtering::class,
        ...
        'projectsMiddlewareFiltering' => \App\Http\Middleware\Projects\Filtering::class,
        ...
        'importProjectsMiddlewareCreate' => \App\Http\Middleware\Import\Projects\Create::class,
        ...
        'expensesMiddlewareFiltering' => \App\Http\Middleware\Expenses\Filtering::class,
        ...
        'invoicesMiddlewareFiltering' => \App\Http\Middleware\Invoices\Filtering::class,
        ...
        'invoicesMiddlewareShowPublic' => \App\Http\Middleware\Invoices\ShowPublic::class,

        //[growcrm] - [estimates]
        'estimatesMiddlewareIndex' => \App\Http\Middleware\Estimates\Index::class,
        'estimatesMiddlewareFiltering' => \App\Http\Middleware\Estimates\Filtering::class,
        ...
        //[growcrm] - [refunds]
        'refundsMiddlewareIndex'   => \App\Http\Middleware\Refunds\Index::class,
        'refundsMiddlewareCreate'  => \App\Http\Middleware\Refunds\Create::class,
        'refundsMiddlewareEdit'    => \App\Http\Middleware\Refunds\Edit::class,
        'refundsMiddlewareDestroy' => \App\Http\Middleware\Refunds\Destroy::class,
        ...
        'itemsMiddlewareFiltering' => \App\Http\Middleware\Items\Filtering::class,
        ...
        'importItemsMiddlewareCreate' => \App\Http\Middleware\Import\Items\Create::class,
        ...
        'leadsMiddlewareFiltering' => \App\Http\Middleware\Leads\Filtering::class,
        ...
        'tasksMiddlewareFiltering' => \App\Http\Middleware\Tasks\Filtering::class,
        ...
        'proposalsMiddlewareFiltering' => \App\Http\Middleware\Proposals\Filtering::class,
        ...
        'contractsMiddlewareFiltering' => \App\Http\Middleware\Contracts\Filtering::class,

...
class Subscriptions extends Controller {
    ...
    public function __construct(
        ...
        //view permission
        $this->middleware('App\Http\Middleware\Landlord\Subscriptions\View')->only([
            'index', 'subscriptionInfo',
        ]);

        //manage permission
        $this->middleware('App\Http\Middleware\Landlord\Subscriptions\Manage')->only([
            'createEditPlan', 'storeUpdatePlan', 'cancelSubscription', 'destroy',
        ]);

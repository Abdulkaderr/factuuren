...
/** --------------------------------------------------------------------------------
 * This controller manages preferences for the landlord admin
 *
 * @package    Grow CRM
 * @author     NextLoop
 *----------------------------------------------------------------------------------*/
...
class Preferences extends Controller {
    ...
    /**
     * Update the users column config for the customers table
    ...
    public function updateTableConfig() {
        ...
        \App\Models\Landlord\TableConfig::where('tableconfig_userid', auth()->id())
            ->Where('tableconfig_table_name', request('tableconfig_table_name'))
            ->update([

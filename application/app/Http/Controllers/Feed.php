...
class Feed extends Controller {
     ...
     */
    /**
     * Ajax search feed for payments (used by Select2 in the refund add modal)
     * Returns payment_id and a formatted label for Select2 consumption
     * @return \Illuminate\Http\Response
     */
    public function payments() {
        ...
        //build query — search by payment id
        $payments = \App\Models\Payment::selectRaw('payment_id, payment_amount, payment_date')
        ...
        foreach ($payments as $payment) {
            $feed[] = [
                ...
                'text' => runtimeRefundIdFormat($payment->payment_id) . ' — ' . runtimeMoneyFormat($payment->payment_amount),
            ];
        }

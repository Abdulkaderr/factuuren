...
use App\Http\Responses\Proposals\AttachProjectResponse;
...
use App\Http\Responses\Proposals\EditTagsResponse;
...
class Proposals extends Controller {
    ...
    public function __construct(
        ...
        //Filtering
        $this->middleware('proposalsMiddlewareFiltering')->only([
            'index',
        ]);
    ...
    public function index(CategoryRepository $categoryrepo, Category $categorymodel) {
        ...
        //get all tags (type: proposal) - for filter panel
        $tags = $this->tagrepo->getByType('proposal');
    ...
    public function store(StoreUpdate $request) {
        ...
        //fire storing event
        event(new \App\Events\Proposals\ProposalStoring(request()));
        ...
        //tags
        $this->tagrepo->add('proposal', $proposal->doc_id);
        ...
        //fire stored event
        event(new \App\Events\Proposals\ProposalStored(request(), $proposal->doc_id, $payload));
    ...
    public function applyDefaultAutomation($proposal) {
        ...
        $proposal->proposal_automation_project_description = $settings->settings2_proposals_automation_project_description;
        ...
        //fire automation applied event
        event(new \App\Events\Proposals\ProposalAutomationApplied(request(), $proposal->doc_id));
    }
    ...
    public function editAutomation($id) {
        ...
        if ($proposal->proposal_automation_status == 'enabled') {
            $automation = [
                ...
                'proposal_automation_project_description' => $proposal->proposal_automation_project_description,
            ];
        ...
        if ($proposal->proposal_automation_status == 'disabled') {
            ...
            $automation = [
                ...
                'proposal_automation_project_description' => config('system.settings2_proposals_automation_project_description'),
            ];
    ...
    public function updateAutomation(ProposalUpdateAutomation $request, $id) {
        ...
        event(new \App\Events\Proposals\ProposalAutomationUpdating(request(), $id));
        ...
        $proposal->proposal_automation_project_description = (request('proposal_automation_project_description') == 'on') ? 'yes' : 'no';
        $proposal->save();
        ...
        if (request('proposal_automation_status') == 'disabled') {
            ...
            $proposal->proposal_automation_project_description = 'no';
            $proposal->save();
        }
        ...
        event(new \App\Events\Proposals\ProposalAutomationUpdated(request(), $id, $payload));
    ...
    public function destroy() {
        ...
        //fire deleting event
        event(new \App\Events\Proposals\ProposalDeleting(request(), $proposal_ids));
        ...
        //fire deleted event
        event(new \App\Events\Proposals\ProposalDeleted(request(), $allrows, $payload));
    ...
    public function bulkDelete() {
        ...
        event(new \App\Events\Proposals\ProposalBulkDeleting(request(), $proposal_ids));
        ...
        event(new \App\Events\Proposals\ProposalBulkDeleted(request(), $proposal_ids, $jsondata));
    ...
    public function changeCategoryUpdate(CategoryRepository $categoryrepo) {
        ...
        event(new \App\Events\Proposals\ProposalCategoryChanging(request(), $proposal_ids));
        ...
        event(new \App\Events\Proposals\ProposalCategoryChanged(request(), $proposal_ids, $payload));
    ...
    public function publish($id) {
        ...
        event(new \App\Events\Proposals\ProposalPublishing(request(), $id));
        ...
        event(new \App\Events\Proposals\ProposalPublished(request(), $id, $payload));
    ...
    public function publishScheduled($id) {
        ...
        //fire scheduling publish event
        event(new \App\Events\Proposals\ProposalSchedulingPublish(request(), $id));
        ...
        event(new \App\Events\Proposals\ProposalPublishScheduled(request(), $id, $payload));
    ...
    public function resendEmail($id) {
        ...
        event(new \App\Events\Proposals\ProposalEmailResending(request(), $id));
        ...
        event(new \App\Events\Proposals\ProposalEmailResent(request(), $id, $payload));
    ...
    public function changeStatus($id) {
        ...
        event(new \App\Events\Proposals\ProposalStatusChanging(request(), $id));
        ...
        event(new \App\Events\Proposals\ProposalStatusChanged(request(), $id, $payload));
    ...
    /**
     * Show the form for attaching a project to a proposal
     * @return \Illuminate\Http\Response
     */
    public function attachProject() {

        //get the proposal
        $proposal = \App\Models\Proposal::Where('doc_id', request()->route('proposal'))->first();

        //get client id
        $client_id = $proposal->doc_client_id;
    ...
    public function attachProjectUpdate() {
        ...
        event(new \App\Events\Proposals\ProposalProjectAttaching(request(), request()->route('proposal')));

        //update the proposal
        $proposal->doc_project_id = request('attach_project_id');
        $proposal->doc_client_id = $project->project_clientid;
        $proposal->save();

        //get refreshed proposal
        $proposals = $this->proposalrepo->search(request()->route('proposal'));
        $proposal = $proposals->first();
        ...
        event(new \App\Events\Proposals\ProposalProjectAttached(request(), request()->route('proposal'), $payload));
    ...
    /**
     * dettach proposal from a project
     * @return \Illuminate\Http\Response
     */
    public function dettachProject() {
        ...
        event(new \App\Events\Proposals\ProposalProjectDetached(request(), request()->route('proposal'), $payload));
    ...
    public function sign($id) {
        ...
        event(new \App\Events\Proposals\Responses\ProposalSign(request(), $payload));
    ...
    public function accepted(ProposalAutomationRepository $automationrepo, $id) {
        ...
        event(new \App\Events\Proposals\ProposalAccepting(request(), $proposal->doc_id));
        ...
        //fire accepted event
        event(new \App\Events\Proposals\ProposalAccepted(request(), $proposal->doc_id, $jsondata));
    ...
    public function declined($id) {
        ...
        event(new \App\Events\Proposals\ProposalDeclining(request(), $proposal->doc_id));
        ...
        //fire declined event
        event(new \App\Events\Proposals\ProposalDeclined(request(), $proposal->doc_id, $jsondata));
    ...
    public function saveSignature() {
        ...
        //fire signature saved event
        event(new \App\Events\Proposals\ProposalSignatureSaved(request(), $signature_path));
    ...
    private function statsWidget($data = array()) {
        ...
        //stats
        $count_accpeted = $this->proposalrepo->search('', ['stats' => 'count-accepted', 'apply_filters' => $apply_filters]);
        $count_pending = $this->proposalrepo->search('', ['stats' => 'count-new', 'apply_filters' => $apply_filters]);
        $count_declined = $this->proposalrepo->search('', ['stats' => 'count-declined', 'apply_filters' => $apply_filters]);
        $sum_accepted = $this->proposalrepo->search('', ['stats' => 'sum-accepted', 'apply_filters' => $apply_filters]);
        ...
        $stats = [
            [
                ...
                'url' => url('proposals?clear-filter=yes&filter_doc_status[]=accepted&source=stats_panels&active_panel=accepted'),
            ],
            [
            ...
            [
                ...
                'url' => url('proposals?clear-filter=yes&filter_doc_status[]=new&source=stats_panels&active_panel=pending'),
            ],
            [
                ...
                'url' => url('proposals?clear-filter=yes&filter_doc_status[]=declined&source=stats_panels&active_panel=declined'),
            ],
        ];
        //return
        return $stats;
    ...
    public function storeClone(CloneProposalRepository $clonerepo, $id) {
        ...
        //fire cloning event
        event(new \App\Events\Proposals\ProposalCloning(request(), $id));
        ...
        //fire cloned event
        event(new \App\Events\Proposals\ProposalCloned(request(), $id, $proposal->doc_id, $payload));
    ...
    public function togglePinning(PinnedRepository $pinrepo, $id) {
        ...
        event(new \App\Events\Proposals\ProposalPinningToggled(request(), $id, $payload));
    ...
    /**
     * update the tags for a proposal
     *
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */
    public function updateTags($id) {
        ...
        //delete & reapply tags
        $this->tagrepo->delete('proposal', $id);
        $this->tagrepo->add('proposal', $id);

        //get updated proposal collection
        $proposals = $this->proposalrepo->search($id);

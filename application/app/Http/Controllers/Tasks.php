...
use App\Events\Tasks\TaskAssignmentChanged;
use App\Events\Tasks\TaskAssignmentChanging;
use App\Events\Tasks\TaskCloned;
use App\Events\Tasks\TaskCloning;
use App\Events\Tasks\TaskDeleted;
use App\Events\Tasks\TaskDeleting;
use App\Events\Tasks\TaskStatusChanged;
use App\Events\Tasks\TaskStatusChanging;
...
class Tasks extends Controller {
    ...
    public function __construct(
        ...
        //Filtering
        $this->middleware('tasksMiddlewareFiltering')->only([
            'index',
        ]);
    ...
    public function store(TaskStoreUpdate $request, TaskAssignedRepository $assignedrepo) {
        ...
        //fire stored event
        event(new TaskStored(request(), $task, $payload));
    ...
    public function destroy(DestroyRepository $destroyrepo) {
        ...
        //fire deleting event
        event(new TaskDeleting(request()));
        ...
        //fire deleted event
        event(new TaskDeleted(request(), $allrows, $payload));
    ...
    public function timerStart($id) {
        ...
        //fire timer starting event
        event(new \App\Events\Tasks\TaskTimerStarting(request(), $id));
    ...
    public function timerStop($id) {
        ...
        //fire timer stopped event
        event(new \App\Events\Tasks\TaskTimerStopped(request(), $id, $payload));
    ...
    public function timerStopAll($id) {
        ...
        //fire timer stopping all event
        event(new \App\Events\Tasks\TaskTimerStoppingAll(request(), $id));
    ...
    public function updateStatus(ProjectPermissions $projectpermissions, $id) {
        ...
        event(new TaskStatusChanging(request(), $task));
        ...
        event(new TaskStatusChanged(request(), $task, $payload));
    ...
    public function updatePriority($id) {
        ...
        event(new \App\Events\Tasks\TaskPriorityChanged(request(), $task, $payload));
    ...
    public function updateAssigned(TaskAssignedRepository $assignedrepo, $id) {
        ...
        //fire assignment changing event
        event(new TaskAssignmentChanging(request(), $task));
        ...
        event(new TaskAssignmentChanged(request(), $task, $payload));
    ...
    public function updateTags($id) {
        ...
        //fire tags changed event
        event(new \App\Events\Tasks\TaskTagsChanged(request(), $task, $payload));
    ...
    public function storeComment(CommentRepository $commentrepo, $id) {
        ...
        //fire comment storing event
        event(new \App\Events\Tasks\TaskCommentStoring(request(), $id));
    ...
    public function StoreChecklist(ChecklistRepository $checklistrepo, $id) {
        ...
        //fire checklist storing event
        event(new \App\Events\Tasks\TaskChecklistStoring(request(), $id));
    ...
    public function toggleStatus() {
        ...
        //fire status toggled event
        event(new \App\Events\Tasks\TaskStatusToggled(request(), $task, $payload));
    ...
    public function attachFiles(Request $request, AttachmentRepository $attachmentrepo, $id) {
        ...
        //fire file attaching event
        event(new \App\Events\Tasks\TaskFileAttaching(request(), $id));
    ...
    public function archive($id) {
        ...
        //fire archiving event
        event(new \App\Events\Tasks\TaskArchiving(request(), $id));
    ...
    public function activate($id) {
        ...
        event(new \App\Events\Tasks\TaskActivated(request(), $task, $payload));
    ...
    public function updateCustomFields($id) {
        ...
        //fire custom fields updated event
        event(new \App\Events\Tasks\TaskCustomFieldsUpdated(request(), $task, $payload));
    ...
    public function cloneStore(ProjectRepository $projectrepo, ProjectPermissions $projectpermissions, TaskAssignedRepository $assignedrepo, $id) {
        ...
        //fire cloning event
        event(new TaskCloning(request(), $id));
        ...
        $payload = [
            'task' => $tasks->first(),
            'tasks' => $tasks,
            'original_task' => \App\Models\Task::Where('task_id', $id)->first(),
            'cloned_task' => $new_task,
        ];

        //fire cloned event
        event(new TaskCloned(request(), $task, $new_task, $payload));
    ...
    public function recurringSettingsUpdate(TaskRecurrringSettings $request, $id) {
        ...
        //fire recurring updated event
        event(new \App\Events\Tasks\TaskRecurringUpdated(request(), $task, $payload));
    ...
    public function stopRecurring() {
        ...
        //fire recurring stopped event
        event(new \App\Events\Tasks\TaskRecurringStopped(request(), $task, $payload));
    ...
    public function storeDependency(TaskDependencyRepository $dependencyrepo, $id) {
        ...
        //fire dependency stored event
        event(new \App\Events\Tasks\TaskDependencyStored(request(), $dependency, $id, $payload));
    ...
    public function deleteDependency($id) {
        ...
        //fire dependency deleted event
        event(new \App\Events\Tasks\TaskDependencyDeleted(request(), $id, request('dependency_id'), $payload));

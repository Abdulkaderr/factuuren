...
class IndexListResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        event(new \App\Events\Leads\Responses\LeadIndexList($request, $this->payload));
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            $html = view($template, compact('page', 'leads', 'stats', 'categories', 'tags', 'statuses', 'fields', 'client_custom_fields'))->render();
            ...
            return view('pages/leads/wrapper', compact('page', 'leads', 'stats', 'categories', 'tags', 'statuses', 'fields', 'client_custom_fields'))->render();
        }
    }
}

...
class IndexKanbanResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        event(new \App\Events\Leads\Responses\LeadIndexKanban($request, $this->payload));
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            if (request('action') == 'load') {
                ...
                $html = view($template, compact('page', 'boards', 'stats', 'categories', 'tags', 'statuses', 'fields', 'client_custom_fields'))->render();
                $jsondata['dom_html'][] = array(
            ...
            return view('pages/leads/wrapper', compact('page', 'boards', 'stats', 'categories', 'tags', 'statuses', 'fields', 'client_custom_fields'))->render();
        }
    }
}

...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //fire event
        event(new \App\Events\Proposals\Responses\ProposalIndex($request, $this->payload));
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            $html = view($template, compact('page', 'proposals', 'stats', 'categories', 'tags'))->render();
            ...
            //for embedded request -change active tabs menu (e.g. client or poject page)
            ...
            return view('pages/proposals/wrapper', compact('page', 'proposals', 'stats', 'categories', 'tags'))->render();
        }
    }
}

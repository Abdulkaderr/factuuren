...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('query-type') == 'filter' && request()->filled('filter_remember')) {
            $jsondata['redirect_url'] = url('/payments');
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            $html = view($template, compact('page', 'payments', 'stats', 'projects', 'tags'))->render();
            ...
            return view('pages/payments/wrapper', compact('page', 'payments', 'stats', 'projects', 'tags'))->render();
        }

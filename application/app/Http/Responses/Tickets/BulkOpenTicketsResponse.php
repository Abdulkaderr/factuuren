...
/** --------------------------------------------------------------------------------
 * This classes renders the response for the [bulkOpenTickets] process for the
 * tickets controller
 * @package    Grow CRM
 * @author     NextLoop
 *----------------------------------------------------------------------------------*/
...
class BulkOpenTicketsResponse implements Responsable {
    ...
    /**
     * render the response for bulk open tickets
     *

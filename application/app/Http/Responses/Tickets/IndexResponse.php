...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //if we are filtering with remember checked, or clearing filter, redirect to reload page
        ...
        //fire event
        event(new \App\Events\Tickets\Responses\TicketIndex($request, $this->payload));
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            $html = view($template, compact('page', 'tickets', 'stats', 'categories', 'fields', 'statuses', 'tags'))->render();
            ...
            //hide filter message on search
            if (request()->filled('search_query')) {
                $jsondata['dom_visibility'][] = [
                    'selector' => '.filtered-results-warning',
                    'action' => 'hide',
                ];
            }
            ...
            return view('pages/tickets/wrapper', compact('page', 'tickets', 'stats', 'categories', 'fields', 'statuses', 'tags'))->render();
        }
    }
}

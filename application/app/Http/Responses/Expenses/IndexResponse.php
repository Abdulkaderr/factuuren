...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //fire event
        event(new \App\Events\Expenses\Responses\ExpenseIndex($request, $this->payload));
        ...
        if (request('query-type') == 'filter' && request()->filled('filter_remember')) {
            $jsondata['redirect_url'] = url('/expenses');
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            $html = view($template, compact('page', 'expenses', 'stats', 'categories', 'projects', 'tags'))->render();
            ...
            return view('pages/expenses/wrapper', compact('page', 'expenses', 'stats', 'categories', 'projects', 'tags'))->render();
        }
    }
}

...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //fire event
        event(new \App\Events\Contracts\Responses\ContractIndex($request, $this->payload));
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            $html = view($template, compact('page', 'contracts', 'stats', 'categories', 'tags'))->render();
            ...
            return view('pages/contracts/wrapper', compact('page', 'contracts', 'stats', 'categories', 'tags'))->render();
        }
    }
}

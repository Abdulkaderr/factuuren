...
class CreateResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //fire event
        event(new \App\Events\Contracts\Responses\ContractCreate($request, $this->payload));
        ...
        //render the form
        $html = view('pages/contracts/components/modals/add-edit-inc', compact('page', 'categories', 'templates', 'tags'))->render();

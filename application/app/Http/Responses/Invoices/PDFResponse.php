...
class PDFResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('view') == 'preview') {
            ...
            return view($this->payload['blade'], compact('page', 'bill', 'taxrates', 'taxes', 'elements', 'lineitems', 'customfields', 'payload'))->render();
        }
        ...
        //render the bill
        $pdf = PDF::loadView($this->payload['blade'], compact('page', 'bill', 'taxrates', 'taxes', 'elements', 'lineitems', 'customfields', 'payload'));

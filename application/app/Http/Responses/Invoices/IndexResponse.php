...
class IndexResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        if (request('source') == 'ext' || request('action') == 'search' || request()->ajax()) {
            ...
            $html = view($template, compact('page', 'invoices', 'stats', 'categories', 'tags', 'projects', 'statuses'))->render();
            ...
            return view('pages/invoices/wrapper', compact('page', 'invoices', 'stats', 'categories', 'tags', 'projects', 'statuses'))->render();
        }
    }
}

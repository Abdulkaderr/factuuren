...
Route::group(['prefix' => 'user'], function () {
    ...
    Route::post("/distraction-free-mode", "User@updateDistractionFreeMode")->middleware(['demoModeCheck']);
});
...
Route::group(['prefix' => 'invoices'], function () {
    ...
    Route::get("/{invoice}/change-client", "Invoices@changeClient")->where('invoice', '[0-9]+');
    Route::post("/{invoice}/change-client", "Invoices@changeClientAction")->where('invoice', '[0-9]+');
    ...
    Route::get("/{invoice}/edit-tags", "Invoices@editTags")->where('invoice', '[0-9]+');
    Route::post("/{invoice}/edit-tags", "Invoices@updateTags")->where('invoice', '[0-9]+');
    ...
    Route::get("/{invoice}/flutterwave-payment", "Invoices@paymentFlutterwave")->where('invoice', '[0-9]+');
    ...
    Route::get("/bulk-change-status", "Invoices@bulkChangeStatus");
    Route::post("/bulk-change-status-update", "Invoices@bulkChangeStatusUpdate");
    Route::post("/bulk-overdue-reminder", "Invoices@bulkOverdueReminder");
    Route::get('/{invoice}/taskbilling', 'Invoices@taskBilling')->where('id', '[0-9]+');
    Route::get("/{invoice}/cancel", "Invoices@cancelCreate")->where('invoice', '[0-9]+');
    Route::post("/{invoice}/cancel", "Invoices@cancelStore")->where('invoice', '[0-9]+');
    Route::post("/{invoice}/restore", "Invoices@restoreInvoice")->where('invoice', '[0-9]+');

    //view from email link
    Route::get("/redirect/{invoice}", "Invoices@redirectURL")->where('invoice', '[0-9]+');

    //public invoice view
    Route::get("/view/{invoice}/pdf", "Invoices@showPublic");
...
Route::group(['prefix' => 'estimates'], function () {
    ...
    Route::get("/{estimate}/manual-automation", "Estimates@manualAutomation")->where('estimate', '[0-9]+');
    Route::post("/{estimate}/manual-automation", "Estimates@manualAutomationAction")->where('estimate', '[0-9]+');
    ...
    Route::post("/bulk-disable-automation", "Estimates@bulkDisableAutomation");
    Route::get("/{estimate}/edit-tags", "Estimates@editTags")->where('estimate', '[0-9]+');
    Route::post("/{estimate}/edit-tags", "Estimates@updateTags")->where('estimate', '[0-9]+');
    Route::get("/{estimate}/create-tasks", "Estimates@createTasks")->where('estimate', '[0-9]+');
    Route::post("/{estimate}/create-tasks", "Estimates@storeTasks")->where('estimate', '[0-9]+');
});
...
Route::group(['prefix' => 'payments'], function () {
    ...
    Route::get("/{payment}/refund-create", "Payments@refundCreate")->where('payment', '[0-9]+');
    Route::post("/{payment}/refund-store", "Payments@refundStore")->where('payment', '[0-9]+');
    Route::delete("/{payment}/refund-destroy", "Payments@refundDestroy")->where('payment', '[0-9]+');
    Route::get("/{payment}/edit-tags", "Payments@editTags")->where('payment', '[0-9]+');
    Route::post("/{payment}/edit-tags", "Payments@updateTags")->where('payment', '[0-9]+');
...
Route::group(['prefix' => 'refunds'], function () {
    Route::any("/search", "Refunds@index")->name('refunds.search');
    Route::post("/delete", "Refunds@destroy")->middleware(['demoModeCheck']);
    Route::get("/{refund}/edit-tags", "Refunds@editTags")->where('refund', '[0-9]+');
    Route::post("/{refund}/edit-tags", "Refunds@updateTags")->where('refund', '[0-9]+');
});
...
Route::group(['prefix' => 'expenses'], function () {
    ...
    Route::get("/{expense}/edit-tags", "Expenses@editTags")->where('expense', '[0-9]+');
    Route::post("/{expense}/edit-tags", "Expenses@updateTags")->where('expense', '[0-9]+');
});
...
Route::group(['prefix' => 'projects'], function () {
    ...
    Route::get("/{project}/edit-tags", "Projects@editTags")->where('project', '[0-9]+');
    Route::post("/{project}/edit-tags", "Projects@updateTags")->where('project', '[0-9]+');
...
Route::group(['prefix' => 'tickets'], function () {
    ...
    Route::post("/bulk-close", "Tickets@bulkCloseTickets");
    Route::post("/bulk-open", "Tickets@bulkOpenTickets");
    ...
    Route::post('/{ticket}/open', 'Tickets@openTicket')->where('ticket', '[0-9]+');
    Route::get('/{ticket}/history', 'Tickets@showHistory')->where('ticket', '[0-9]+');
...
Route::group(['prefix' => 'proposals'], function () {
    ...
    Route::get("/{proposal}/edit-tags", "Proposals@editTags")->where('proposal', '[0-9]+');
    Route::post("/{proposal}/edit-tags", "Proposals@updateTags")->where('proposal', '[0-9]+');
...
Route::group(['prefix' => 'contracts'], function () {
    ...
    Route::get("/{contract}/edit-tags", "Contracts@editTags")->where('contract', '[0-9]+');
    Route::post("/{contract}/edit-tags", "Contracts@updateTags")->where('contract', '[0-9]+');
...
Route::group(['prefix' => 'feed'], function () {
    ...
    Route::get("/payments", "Feed@payments");
...
Route::group(['prefix' => 'settings/flutterwave'], function () {
    Route::get("/", "Settings\Flutterwave@index")->middleware(['demoModeCheck']);
    Route::put("/", "Settings\Flutterwave@update")->middleware(['demoModeCheck']);
});
...
Route::group(['prefix' => 'api'], function () {
    ...
    Route::any("/flutterwave/webhooks", "API\Flutterwave\Webhooks@index");
});

...
return [
    ...
    'execute_sql_queries' => "Execute Queries",
    ...
    'passed_executions' => 'Passed Executions',
    'showing' => 'Showing',
    'failed_executions' => 'Failed Executions',
    'all_executions' => 'All Executions',
    'add_another_time_record' => "Add Another Time Record",
    'client_present_sign' => "Client Present - Sign",
    'sign_contract_client_present' => "Sign Contract - Client Present",
    'invoice_due_days' => "Invoice Due Days",
    'invoice_due_days_info' => "Number of days until invoice payment is due (leave blank to use system default)",
    'system_invoice_due_days' => "Default Invoice Due Days",
    'system_invoice_due_days_info' => "System-wide default number of days for invoice payment due dates",
    'set_due_date_automatically' => "Set Automatically",
    'set_due_date_manually' => "Set Manually",
    'invoice_date_plus' => "Invoice Date +",
    'day' => "day",
    'default_tax_info' => "Default tax rate for this product. This can be changed when creating invoices",
    'advanced' => 'Advanced',
    'default_invoice_tax_mode' => 'Default Invoice Tax Mode',
    'invoice_mode' => 'Invoice Mode',
    'change_invoice_mode' => 'Change Invoice Mode',
    ...
    'part_paid_status' => "Part Paid Status",
    'paid_status' => "Paid Status",
    'change_invoice_status' => "Change Invoice Status",
    'move_invoices' => "Move Invoices",
    'move_invoices_to_status' => "Move invoices to status",
    'invoice_status_already_exists' => "This invoice status already exists",
    'status_has_invoices_cannot_delete' => "Cannot delete status with invoices linked to it",
    'required_invoice_status' => "Required invoice status",
    'edit_invoice_status' => "Edit Invoice Status",
    'add_new_invoice_status' => "Add New Invoice Status",
    'delete_invoice_status' => "Delete Invoice Status",
    'current_status' => "Current Status",
    'add_product_unit' => "Add Product Unit",
    'delete_unit' => "Delete Unit",
    'unit_name' => "Unit Name",
    'unit_cannot_be_deleted_in_use' => "This unit cannot be deleted because it is currently being used by :count product(s). Please change or remove the unit from those products first.",
    'select_or_type_unit' => "Select or type a unit",
    'unit_name_too_long' => "Unit name is too long (maximum 50 characters)",
    'printable_view' => "Printable View",
    'import_items' => "Import Items",
    'importing_items' => "Importing Items",
    'items_imported_successfully' => "Items imported successfully",
    'skip_duplicate_items' => "Skip duplicate items",
    'show_on_invoice' => "Show On Invoice",
    'enter_field_name' => "Enter field name",
    'maximum_255_characters' => "Maximum 255 characters",
    'products_custom_fields_info' => 'It will be displayed on invoice line items',
    'invoices_show_long_product_descriptions' => 'Show long product description',
    'custom_field' => "Custom Field",
    'long_description' => 'Long Description',
    'item_custom_fields_warning' => 'Clearing/deleting a custom field name will permanently delete all stored data for that field across all products. This action cannot be undone.',
    'tax_status' => "Tax Status",
    'taxable' => 'Taxable',
    'exempt' => 'Exempt',
    'contract_automation' => "Contract Automation",
    'contract_automation_default' => "Contract Automation (default status)",
    'contract_automation_default_info' => "If enabled, this automation will be available when creating a new contract",
    'contract_automation_info_1' => "When a contract is signed by the client, do the following",
    'contract_automation_info_2' => "These are the default settings, but you can still change them on a contract by contract basis",
    'automation_enabled' => "Automation Enabled",
    'enable_automation' => "Enable Automation",
    'automation_will_create_project_invoice' => "When enabled, automation will create a project and/or invoice when the contract is signed by the client",
    'contract_already_signed' => 'Contract has already been signed',
    'overdue_invoice_reminders' => "Overdue Invoice Reminders",
    'overdue_invoice_reminders_info' => "Configure automatic email reminders for overdue invoices. Set to 0 to disable a reminder.",
    'third_reminder' => "Third Reminder",
    'third_reminder_must_be_greater' => "Third reminder days must be greater than second reminder days",
    'remember_filters' => "Remember Filters",
    'forget_filters' => "Forget Filters",
    'pending_checklist_items' => "Pending Checklist Items",
    'pending_checklist' => "Pending Checklist",
    'has_pending_checklists' => "Has Pending Checklists",
    'set_as_account_owner' => "Set As Account Owner",
    'confirm_set_account_owner' => "Set As Account Owner",
    'confirm_set_account_owner_text' => "Are you sure you want to set this user as the account owner?",
    'user_already_account_owner' => "This user is already the account owner",
    'these_results_are' => "These results are",
    'filtered' => "filtered",
    'you_can' => "You can",
    'execute_sql_queries' => "Execute SQL Queries",
    'clear_the_filters' => "clear the filters",
    'importing_projects' => "Importing Projects",
    'rows_skipped' => "Rows Skipped",
    'rows_skipped_invalid_client' => "Rows Skipped (Invalid Client)",
    'queued' => "Queued",
    'invoice_value' => "Invoice Value",
    'estimate_value' => "Estimate Value",
    'leads_converted_value' => "Leads Converted Value",
    ...
    'proposals_value' => "Proposals Value",
    'contracts_value' => "Contracts Value",
    'system_health' => "System Health",
    'last_logged_in' => "Last Logged In",
    'cronjob_last_run' => "Cronjob Last Run",
    'delivery_setting' => "Delivery Setting",
    'crm_mail_server' => "CRM Mail Server",
    'own_smtp_server' => "Own SMTP Server",
    'select_log_type' => "Select Log Type",
    'email_delivery_errors' => "Email Delivery Errors",
    'all_types' => "All Types",
    'view_log' => "View Log",
    'select_log_type_from_dropdown' => "Select a log type from the dropdown to view error logs",
    'maintenance_mode' => "Maintenance Mode",
    'maintenance_mode_status' => "Maintenance Mode Status",
    'maintenance_mode_message' => "Maintenance Mode Message",
    'signup_form_settings' => "Signup Form Settings",
    'not_included' => "Not Included",
    'subscription_type' => "Subscription Type",
    'unsubscribed' => "Unsubscribed",
    'signup_period' => "Signup Period",
    'signup_date' => "Signup Date",
    'converted_leads' => "Converted Leads",
    
    //--------------V3.2 Language Changes-------------------
    'invoice_url' => "Invoice URL",
    'webhook_secret_hash' => "Webhook Secret Hash",
    'flutterwave_general_info' => "Get this from inside your Flutterwave dashboard",
    'flutterwave_webhook_hash_info' => "User-defined secret hash for webhook verification",
    'copied' => "Copied",
    'column_tax_rate' => "Tax Rate",
    'column_tax_name' => "Tax",
    'new_user' => "New User",
    'direct_email_requires_imap' => "New user tickets can only be created for departments with IMAP email integration enabled",
    'net_total' => "Net Total",
    'change_client' => "Change Client",
    'invoice_already_paid' => "This invoice has already been paid or partially paid",
    'action_not_allowed_for_subscription_invoices' => "This action is not allowed for subscription invoices",
    'action_not_allowed_for_recurring_invoices' => "This action is not allowed for recurring invoices that have issued child invoices",
    'errors' => "Errors",
    ...
    'customer_platform_usage' => "Customer Platform Usage",
    'resellers' => "Resellers",
    'staff' => "Staff",
    'refund' => "Refund",
    'refunds' => "Refunds",
    ...
    'payment_already_refunded' => "This payment already has a refund",
    'payment_not_found' => "A payment with that ID could not be found.",
    ...
    'invoice_cancelled_by' => "Invoice Cancelled By",
    'refund_all_payments' => "Refund All Payments",
    'invoice_cancellation_notes' => "Invoice Cancellation Notes",
    'distraction_free_mode' => "Distraction Free Mode",
    'automation_proposal_as_project_description' => "Use proposal as project description",
    'close_ticket' => "Close Ticket",
    'close_tickets' => "Close Tickets",
    'open_ticket' => "Open Ticket",
    'on_reply' => "On Reply",
    'stay_on_page' => "Stay On Ticket Page",
    'return_to_list' => "Return To Tickets List",
    ...
    'create_tasks_requires_project' => "This feature is only available when the estimate is attached to a project",
    'create_tasks_from_lineitems_info' => "Select the line items below to create as tasks. Each selected item will create a new task in the attached project.",
    'create_tasks_previously_converted' => "Greyed out line items have already been converted to tasks for this project and cannot be selected again.",
    'create_tasks_all_converted' => "Could not create tasks. All selected line items have already been converted to tasks for this project.",
    'manually_run_automation' => "Manually Run Automation",
    'estimate_must_be_accepted_for_automation' => "Note: The estimate must be in Accepted status for this automation to run.",
    'automation_already_run_for_this_estimate' => "An automation has already been run for this estimate",
    'cancellation_reason_is_required' => "Cancellation reason is requried",
];
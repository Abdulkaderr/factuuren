    ...
    <div class="filtered-results-warning opacity-8 p-b-0 p-l-20 p-t-10">
        <small>
            ...
            <a href="javascript:void(0);" class="js-toggle-side-panel"
                data-target="sidepanel-filter-invoices">@lang('lang.filtered')</a>.
            @lang('lang.you_can')
            ...
            <table id="invoices-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list"
                ...
                <thead>
                    <tr>
                        ...
                        <th class="invoices_col_tags {{ config('table.tableconfig_column_24') }} tableconfig_column_24">
                            <a href="javascript:void(0)">@lang('lang.tags')</a>
                        </th>
                        @endif

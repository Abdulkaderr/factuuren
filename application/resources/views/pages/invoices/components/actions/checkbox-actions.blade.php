<div class="col-12 align-self-center hidden checkbox-actions  box-shadow-minimum"
    ...
    <div class="x-buttons">
        ...
        <button type="button"
            ...
            data-url="{{ urlResource('/invoices/bulk-change-status') }}"
            data-action-url="{{ urlResource('/invoices/bulk-change-status-update') }}" data-action-method="POST"
            data-action-type="form" data-action-form-id="main-body" data-loading-target="actionsModalBody"
            data-skip-checkboxes-reset="TRUE" id="checkbox-actions-change-status-invoices">
        ...
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-info"
            data-type="form" data-ajax-type="POST" data-form-id="invoices-list-table"
            data-url="{{ url('/invoices/bulk-overdue-reminder') }}"
            data-confirm-title="{{ cleanLang(__('lang.send_overdue_reminder')) }}"
            data-confirm-text="{{ cleanLang(__('lang.are_you_sure')) }}" id="checkbox-actions-overdue-reminder-invoices">
            <i class="ti-email"></i> {{ cleanLang(__('lang.send_overdue_reminder')) }}</button>

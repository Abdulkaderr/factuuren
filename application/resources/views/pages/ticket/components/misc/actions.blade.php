...
<div class="col-md-12  col-lg-3 align-self-center text-right parent-page-actions p-b-9"
        ...
        <div id="list-page-actions">
                ...
                <button type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.close')) }}"
                        class="list-actions-button btn btn-page-actions waves-effect waves-dark confirm-action-danger"
                        data-confirm-title="{{ cleanLang(__('lang.close')) }}"
                        data-confirm-text="{{ cleanLang(__('lang.are_you_sure')) }}"
                        data-ajax-type="POST"
                        data-url="{{ url('/tickets/'.$ticket->ticket_id.'/close') }}">
                ...
                <!--change status-->
                @if(config('visibility.action_buttons_edit'))
                <button type="button" title="{{ cleanLang(__('lang.change_status')) }}"
                        ...
                        data-url="{{ url('/tickets/change-status?id='.$ticket->ticket_id.'&source=page') }}"

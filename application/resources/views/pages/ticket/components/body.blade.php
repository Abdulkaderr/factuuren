        ...
        <div class="card-body card x-message p-t-0" id="ticket-body">
            ...
            <div class="x-body">
                <div class="d-flex justify-content-between align-items-center m-b-20">
                    ...
                    <div>
                        <a href="javascript:void(0);"
                            class="btn btn-xs btn-outline-info js-toggle-side-panel-ajax m-t--20"
                            data-target="sidepanel-ticket-history"
                            data-reset-body-id="sidepanel-ticket-history-body"
                            data-url="{{ url('tickets/'.$ticket->ticket_id.'/history') }}"
                            data-ajax-type="GET"
                            data-loading-target="sidepanel-ticket-history-body">
                            @lang('lang.view_ticket_history')
                        </a>
                    </div>
                    <!--view ticket history button-->

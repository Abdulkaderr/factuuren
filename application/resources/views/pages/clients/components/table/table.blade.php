    ...
    <div class="filtered-results-warning opacity-8 p-b-0 p-l-20 p-t-10">
        <small>
            ...
            <a href="javascript:void(0);" class="js-toggle-side-panel"
                data-target="sidepanel-filter-clients">@lang('lang.filtered')</a>.
            @lang('lang.you_can')
            <a href="{{ url('/clients?clear-filter=yes') }}">@lang('lang.clear_the_filters')</a>.
        </small>
    </div>
    @endif
                    ...
                    <tr>
                        ...
                        <th
                            ...
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_client_company_name"
                                ...
                                @lang('lang.name')<span class="sorting-icons"><i

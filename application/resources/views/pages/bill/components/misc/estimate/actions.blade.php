...
<div class="col-md-12  col-lg-5 align-self-center text-right p-b-9  {{ $page['list_page_actions_size'] ?? '' }} {{ $page['list_page_container_class'] ?? '' }}"
    ...
    <div id="list-page-actions">
        ...
        <button type="button"
            title="{{ cleanLang(__('lang.create_tasks')) }}"
            ...
            data-modal-title="{{ cleanLang(__('lang.create_tasks')) }}"
            data-url="{{ urlResource('/estimates/' . $bill->bill_estimateid . '/create-tasks') }}"
            data-loading-target="commonModalBody"
            data-action-url="{{ urlResource('/estimates/' . $bill->bill_estimateid . '/create-tasks') }}"
        ...
        <span class="dropdown">
            <button type="button" data-toggle="dropdown"
                title="{{ cleanLang(__('lang.automation')) }}"
                aria-haspopup="true" aria-expanded="false"
                class="data-toggle-tooltip list-actions-button btn btn-page-actions waves-effect waves-dark">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                ...
                <a href="javascript:void(0)"
                    ...
                    data-loading-target="commonModalBody"
                    data-modal-title="@lang('lang.estimate_automation')"
                    data-action-url="{{ urlResource('/estimates/'.$bill->bill_estimateid.'/edit-automation') }}"
                    data-action-method="POST"
                    data-action-ajax-loading-target="commonModalBody">
                    <i class="sl-icon-energy display-inline-block p-r-5"></i>@lang('lang.automation')
                </a>
                ...
                <a href="javascript:void(0)"
                    class="dropdown-item edit-add-modal-button js-ajax-ux-request reset-target-modal-form"
                    data-toggle="modal" data-target="#commonModal"
                    data-url="{{ urlResource('/estimates/'.$bill->bill_estimateid.'/manual-automation') }}"
                    data-loading-target="commonModalBody"
                    data-modal-title="@lang('lang.manually_run_automation')"
                    data-action-ajax-loading-target="commonModalBody">
                    <i class="ti-control-play display-inline-block p-r-5"></i>@lang('lang.manually_run_automation')
                </a>

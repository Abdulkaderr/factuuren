    ...
    <div class="card card-body invoice-wrapper box-shadow" id="invoice-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-12 m-b-10 billing-mode-only-item" id="invoice-dates-wrapper">
                ...
                @include('pages.bill.components.elements.estimate.converted-invoice')
            </div>
            <!--module extension point-->
            ...
            @if($bill->bill_type == 'invoice' && $bill->bill_cancellation_date != null)
            <div class="alert alert-danger m-t-10">
                <strong>{{ runtimeDate($bill->bill_cancellation_date) }} - @lang('lang.invoice_cancelled_by') - {{ $bill->cancelledBy->first_name ?? '' }} {{ $bill->cancelledBy->last_name ?? '' }}</strong>
                <br>{{ $bill->bill_cancellation_reasons }}
            </div>
            @endif
            </div>
            ...
            <div class="col-12 billing-mode-only-item">
                ...
                <div class="p-t-25 invoice-pay" id="invoice-buttons-container">
                    <div class="text-right">
                        ...
                        <span>
                            @if($bill->bill_type == 'invoice')
                            <a class="btn btn-secondary btn-outline" id="buttons-container-invoice-download-button"
                            ...
                            <a class="btn btn-secondary btn-outline" id="buttons-container-estimate-download-button"

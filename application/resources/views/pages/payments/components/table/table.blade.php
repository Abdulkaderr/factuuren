    ...
    <div class="card-body">
        ...
        <div class="filtered-results-warning opacity-8 p-b-5">
            <small>
                ...
                <a href="javascript:void(0);" class="js-toggle-side-panel" data-target="sidepanel-filter-payments">@lang('lang.filtered')</a>.
                @lang('lang.you_can')
                <a href="{{ url('/payments?clear-filter=yes') }}">@lang('lang.clear_the_filters')</a>.
            </small>
        </div>
        @endif
            ...
            <table id="payments-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list"
                ...
                <thead>
                    <tr>
                        ...
                        <th class="payments_col_refund"><a href="javascript:void(0)">{{ cleanLang(__('lang.refund')) }}</a></th>
                        @endif
                        ...
                        <!--status column (Paid / Refunded badge)-->
                        @if(config('visibility.payments_col_status'))
                        <th class="payments_col_status"><a href="javascript:void(0)">{{ cleanLang(__('lang.status')) }}</a></th>
                        @endif

                        @if(config('visibility.payments_col_tags'))
                        <th class="payments_col_tags"><a href="javascript:void(0)">{{ cleanLang(__('lang.tags')) }}</a></th>
                        @endif

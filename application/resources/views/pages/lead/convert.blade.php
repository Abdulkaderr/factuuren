<div class="p-40" id="convert-lead-form">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-lg-9">
            <input type="text" class="form-control form-control-sm" id="convert_lead_phone" name="client_phone"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-lg-9">
            <input type="text" class="form-control form-control-sm" id="convert_lead_street"
                name="client_billing_street" placeholder="" value="{{ $lead->lead_street ?? '' }}">
        </div>
    </div>
    <!--city-->
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-lg-9">
            <input type="text" class="form-control form-control-sm" id="convert_lead_city" name="client_billing_city"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-lg-9">
            <input type="text" class="form-control form-control-sm" id="convert_lead_state" name="client_billing_state"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-lg-9">
            <input type="text" class="form-control form-control-sm" id="convert_lead_zip" name="client_billing_zip"
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-lg-9">
            <select class="select2-basic-with-search form-control form-control-sm" id="convert_lead_country"
    ...
    @if(isset($client_custom_fields) && $client_custom_fields->count() > 0)
    @php $fields = $client_custom_fields; @endphp

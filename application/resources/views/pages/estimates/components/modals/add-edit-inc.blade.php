    ...
    <div class="col-lg-12">
        ...
        <div class="client-selector">
            ...
            <div class="client-selector-container hidden" id="client-new-container">
                ...
                <!--module extension point-->
                @stack('form_estimat_add_edit_3')
            </div>


            <!--module extension point-->
            @stack('form_estimat_add_edit_4')
        ...
        <!--module extension point-->
        @stack('form_estimat_add_edit_10')
        ...
        <!--module extension point-->
        @stack('form_estimat_add_edit_11')
        ...
        <div class="hidden" id="edit_bill_options_toggle">
            ...
            <!--module extension point-->
            @stack('form_estimat_add_edit_12')
        ...
        <!--module extension point-->
        @stack('form_estimat_add_edit_13')
    </div>
</div>
<div class="col-lg-12 align-self-center hidden checkbox-actions box-shadow-minimum"
    ...
    <div class="x-buttons">
        ...
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-info"
            data-type="form" data-ajax-type="POST" data-form-id="estimates-list-table"
            data-url="{{ url('/estimates/bulk-disable-automation') }}"
            data-confirm-title="{{ cleanLang(__('lang.disable_automation')) }}"
            data-confirm-text="{{ cleanLang(__('lang.are_you_sure')) }}" id="checkbox-actions-disable-automation-estimates">
            <i class="sl-icon-settings"></i> {{ cleanLang(__('lang.disable_automation')) }}</button>
    </div>
    @else
    <div class="x-notice">

...
<form class="form" id="settings-proposals-automation">
    ...
    <div class="{{ proposalAutomationVisibility($settings->settings2_proposals_automation_default_status) }}"
        ...
        <div class="card-contrast-panel m-l-30 {{ proposalAutomationVisibility($settings->settings2_proposals_automation_create_project) }}"
            ...
            <!--settings2_proposals_automation_project_description-->
            <div class="form-group form-group-checkbox row">
                <label
                    class="col-sm-12 col-lg-4 col-form-label text-left">@lang('lang.automation_proposal_as_project_description')</label>
                <div class="col-sm-12 col-lg-8 text-left p-t-5">
                    <input type="checkbox" id="settings2_proposals_automation_project_description"
                        {{ runtimePrechecked($settings->settings2_proposals_automation_project_description ?? '') }}
                        name="settings2_proposals_automation_project_description" class="filled-in chk-col-light-blue">
                    <label class="p-l-30" for="settings2_proposals_automation_project_description"></label>
                </div>
            </div>

...
<form class="form">
    ...
    <!--settings2_tickets_on_reply-->
    <div class="form-group row">
        <label class="col-sm-12 text-left control-label col-form-label">@lang('lang.on_reply')</label>
        <div class="col-sm-12">
            <select class="select2-basic form-control form-control-sm select2-preselected"
                id="settings2_tickets_on_reply" name="settings2_tickets_on_reply"
                data-width="element"
                data-preselected="{{ $settings->settings2_tickets_on_reply ?? 'return-to-list' }}">
                <option></option>
                <option value="return-to-list">@lang('lang.return_to_list')</option>
                <option value="stay-on-page">@lang('lang.stay_on_page')</option>
            </select>
        </div>
    </div>

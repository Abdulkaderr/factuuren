    ...
    <div class="filtered-results-warning opacity-8 p-b-0 p-l-20 p-t-10">
        <small>
            ...
            <a href="javascript:void(0);" class="js-toggle-side-panel"
                data-target="sidepanel-filter-expenses">@lang('lang.filtered')</a>.
            @lang('lang.you_can')
            <a href="{{ url('/expenses?clear-filter=yes') }}">@lang('lang.clear_the_filters')</a>.
        </small>
    </div>
    @endif
    <div class="card-body">
            ...
            <table id="expenses-list-table" class="table m-t-0 m-b-0 table-hover no-wrap expense-list"
                ...
                <thead>
                    <tr>
                        ...
                        <th class="expenses_col_tags"><a href="javascript:void(0)">{{ cleanLang(__('lang.tags')) }}</a></th>
                        @endif

        ...
        <div class="filtered-results-warning opacity-8 p-b-0 p-l-20 p-t-10">
            <small>
                ...
                <a href="javascript:void(0);" class="js-toggle-side-panel"
                    data-target="sidepanel-filter-projects">@lang('lang.filtered')</a>.
                @lang('lang.you_can')
                <a href="{{ url('/projects?clear-filter=yes') }}">@lang('lang.clear_the_filters')</a>.
            </small>
        </div>
        @endif
        <div class="card-body">
            <div class="table-responsive list-table-wrapper">
                ...
                <table id="projects-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list"
                    ...
                    <!--module extension point - allows modules to inject content-->
                    @stack('table_4')
                    <tfoot id="projects-footer-container">
                        <tr>
                            <td colspan="20">
                                <!--load more button-->

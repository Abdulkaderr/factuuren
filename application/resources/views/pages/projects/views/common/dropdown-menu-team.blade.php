...
<a class="dropdown-item actions-modal-button js-ajax-ux-request reset-target-modal-form edit-add-modal-button"
    ...
    data-url="{{ url('/projects/'.$project->project_id.'/edit-tags') }}" data-loading-target="commonModalBody"
    data-modal-title="@lang('lang.edit_tags')"
    data-action-url="{{ url('/projects/'.$project->project_id.'/edit-tags') }}" data-action-method="POST"
    data-action-ajax-class="ajax-request" data-action-ajax-loading-target="projects-td-container">
    @lang('lang.edit_tags')
</a>

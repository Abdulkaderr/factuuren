...
<div class="card-group table-stats-cards  {{ runtimePreferenceStatsPanelPosition(auth()->user()->stats_panel_position) }}" id="list-pages-stats-widget">
    ...
    <div class="card">
        <div class="card-body click-url cursor-pointer {{ runtimeActiveStatsPanel($stat['active_panel']) }}"
            data-url="{{ url('tickets?clear-filter=yes&filter_ticket_status[]=' . $stat['status_id'] . '&source=stats_panels&active_panel=' . $stat['active_panel']) }}">
            <div class="row">
                <div class="col-12">

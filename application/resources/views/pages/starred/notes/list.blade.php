...
<div class="card m-b-2 bg-contrast border-radius-8 m-b-30 starred-feed-item"
    ...
    <div class="card-body p-t-10 p-b-10">
        <div class="d-flex justify-content-between align-items-start">
            <div class="flex-grow-1 edit-add-modal-button ajax-request reset-target-modal-form" style="cursor: pointer;" data-toggle="modal"
                data-target="#commonModal" data-url="{{ url('/notes/'.$note->note_id) }}"
                data-loading-target="commonModalBody" data-modal-title=" " data-footer-visibility="hidden">
        ...
        <div class="d-flex align-items-center justify-content-between m-t-10 edit-add-modal-button ajax-request reset-target-modal-form"
            style="cursor: pointer;" data-toggle="modal" data-target="#commonModal"
            data-url="{{ url('/notes/'.$note->note_id) }}" data-loading-target="commonModalBody" data-modal-title=" " data-footer-visibility="hidden">
            <!--note type label-->
            <div>

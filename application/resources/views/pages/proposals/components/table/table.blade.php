...
<div class="filtered-results-warning opacity-8 p-b-5">
    <small>
        ...
        <a href="javascript:void(0);" class="js-toggle-side-panel" data-target="sidepanel-filter-proposals">@lang('lang.filtered')</a>.
        @lang('lang.you_can')
        <a href="{{ url('/proposals?clear-filter=yes') }}">@lang('lang.clear_the_filters')</a>.
    </small>
</div>
@endif
            ...
            <table id="proposals-list-table" class="table m-t-0 m-b-0 table-hover no-wrap proposal-list"
                ...
                <thead>
                    <tr>
                        ...
                        <th class="proposals_col_tags"><a href="javascript:void(0)">@lang('lang.tags')</a></th>
                        @endif

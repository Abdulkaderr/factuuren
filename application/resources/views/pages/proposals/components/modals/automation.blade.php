    ...
    <div class="p-t-10 client-selector {{ proposalAutomationVisibility($automation['proposal_automation_default_status']) }}"
        ...
        <div class="card-contrast-panel m-l-30 {{ proposalAutomationVisibility($automation['proposal_automation_create_project']) }}"
            ...
            <!--proposal_automation_project_description-->
            <div class="form-group form-group-checkbox row">
                <label
                    class="col-sm-12 col-lg-6 col-form-label text-left">@lang('lang.automation_proposal_as_project_description')</label>
                <div class="col-sm-12 col-lg-6 text-left p-t-5">
                    <input type="checkbox" id="proposal_automation_project_description"
                        {{ runtimePrechecked($automation['proposal_automation_project_description'] ?? '') }}
                        name="proposal_automation_project_description" class="filled-in chk-col-light-blue">
                    <label class="p-l-30" for="proposal_automation_project_description"></label>
                </div>
            </div>

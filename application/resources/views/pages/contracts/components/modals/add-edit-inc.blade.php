...
<!--tags-->
<div class="form-group row">
    <label class="col-12 text-left control-label col-form-label">@lang('lang.tags')</label>
    <div class="col-12">
...
<div class="form-group form-group-checkbox row">
    <div class="col-12 text-left p-t-5">
        <input type="checkbox" id="contract_automation_status" name="contract_automation_status" class="filled-in chk-col-light-blue"
            {{ runtimePrechecked2('checked', config('system.settings2_contracts_automation_default_status'), 'enabled') }}>
        <label for="contract_automation_status">{{ cleanLang(__('lang.enable_automation')) }}</label>
        <small class="form-text text-muted">{{ cleanLang(__('lang.automation_will_create_project_invoice')) }}</small>
    </div>
</div>
@endif

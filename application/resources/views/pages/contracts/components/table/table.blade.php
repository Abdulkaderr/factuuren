...
<div class="filtered-results-warning opacity-8 p-b-5">
    <small>
        ...
        <a href="javascript:void(0);" class="js-toggle-side-panel" data-target="sidepanel-filter-contracts">@lang('lang.filtered')</a>.
        @lang('lang.you_can')
        <a href="{{ url('/contracts?clear-filter=yes') }}">@lang('lang.clear_the_filters')</a>.
    </small>
</div>
@endif
            ...
            <table id="contracts-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contract-list"
                ...
                <thead>
                    <tr>
                        ...
                        <th class="contracts_col_tags"><a href="javascript:void(0)">@lang('lang.tags')</a></th>
                        @endif

...
<tr id="note_{{ $note->note_id }}">
    ...
    <td class="notes_col_title">
        <a href="javascript:void(0)" class="edit-add-modal-button js-ajax-ux-request reset-target-modal-form" data-toggle="modal"
            data-url="{{ url('/') }}/notes/{{  $note->note_id }}" data-target="#commonModal"
    ...
    <td class="notes_col_action  actions_column {{ $page[ 'visibility_col_action'] ?? '' }} ">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <a href="javascript:void(0)" title="{{ cleanLang(__('lang.view')) }}"
                ...
                data-toggle="modal" data-url="{{ url( '/') }}/notes/{{  $note->note_id }} " data-target="#commonModal"
                data-loading-target="commonModalBody" data-modal-title=" " data-footer-visibility="hidden">

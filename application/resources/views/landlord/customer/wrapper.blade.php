        ...
        <div class="col-lg-4 col-xlg-3 col-md-5">
            <div class="card">
                ...
                <div class="card-body p-t-0">
                    ...
                    <!--subscription details - only visible with customer subscription permission-->
                    @if(config('visibility.customer_tab_subscription'))
        ...
        <div class="col-lg-8 col-xlg-9 col-md-7">
            <div class="card">
                ...
                <ul class="nav nav-tabs profile-tab" role="tablist">
                    <!--timeline-->
                    @if(config('visibility.customer_tab_timeline'))
                    ...
                    @endif
                    <!--payments-->
                    @if(config('visibility.customer_tab_payments'))
                    ...
                    <li class="nav-item"> <a class="nav-link cursor-pointer ajax-request" data-toggle="tab"
                            data-url="{{ url('app-admin/customers/'.$customer->tenant_id.'/platform-usage') }}"
                            data-loading-target="dynamic-content-container" role="tab">@lang('lang.platform_usage')</a>
                    </li>
                    @endif
                    <!--error logs-->
                    <li class="nav-item"> <a class="nav-link cursor-pointer ajax-request" data-toggle="tab"
                            data-url="{{ url('app-admin/customers/'.$customer->tenant_id.'/error-logs') }}"
                            data-loading-target="dynamic-content-container" role="tab">@lang('lang.error_logs')</a>
                    </li>
                </ul>
                <!-- Tab panes -->
